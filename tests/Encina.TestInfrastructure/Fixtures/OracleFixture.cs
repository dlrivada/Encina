...
public sealed class OracleFixture : DatabaseFixture<IContainer>
{
    ...
    protected override async Task<IContainer> CreateContainerAsync()
    {
        ...
        _connectionString = $"Data Source=(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(HOST=localhost)(PORT={port}))(CONNECT_DATA=(SERVICE_NAME=FREEPDB1)));User Id=Encina;Password=SimplePwd123;";
