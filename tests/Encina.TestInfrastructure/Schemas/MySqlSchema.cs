...
public static class MySqlSchema
{
    ...
    /// </summary>
    public static async Task CreateAbacSchemaAsync(MySqlConnection connection)
    {
        const string sql = """
    ...
    /// </summary>
    public static async Task CreateProcessingActivitySchemaAsync(MySqlConnection connection)
    {
        const string sql = """
            CREATE TABLE IF NOT EXISTS `ProcessingActivities` (
                `Id`                             VARCHAR(36)   NOT NULL PRIMARY KEY,
                `RequestTypeName`                VARCHAR(768)  NOT NULL,
