...
/// </summary>
[Trait("Category", "Load")]
public sealed class ScheduledMessageStoreDapperLoadTests : IClassFixture<SqliteFixture>
{
    private readonly SqliteFixture _database;
    private readonly ScheduledMessageStoreDapper _store;

    public ScheduledMessageStoreDapperLoadTests(SqliteFixture database)
    {
        _database = database;
