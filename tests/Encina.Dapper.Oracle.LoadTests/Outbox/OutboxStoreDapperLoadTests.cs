...
public sealed class OutboxStoreDapperLoadTests : IClassFixture<OracleFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly OracleFixture _fixture;
    private readonly OutboxStoreDapper _store;

    public OutboxStoreDapperLoadTests(OracleFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
