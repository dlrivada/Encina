...
namespace Encina.Extensions.Resilience.LoadTests;

/// <summary>
/// Load tests for Encina with Standard Resilience using NBomber.
...
public class StandardResilienceLoadTests
{
    ...
    public async Task HighConcurrency_RateLimiter_ShouldThrottle()
    {
        ...
        services.AddLogging();
        services.AddEncina(typeof(StandardResilienceLoadTests).Assembly);
