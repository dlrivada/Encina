...
public sealed class OutboxStoreDapperLoadTests : IClassFixture<MySqlFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly MySqlFixture _fixture;
    private readonly OutboxStoreDapper _store;

    public OutboxStoreDapperLoadTests(MySqlFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
