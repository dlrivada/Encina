...
namespace Encina.ADO.MySQL.ContractTests.Health;

/// <summary>
/// Contract tests for <see cref="MySqlHealthCheck"/> (ADO.NET) ensuring it follows the IEncinaHealthCheck contract.
/// </summary>
