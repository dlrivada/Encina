...
namespace Encina.Dapper.Oracle.Tests.Inbox;

/// <summary>
/// Contract tests for <see cref="InboxStoreDapper"/>.
/// Verifies compliance with <see cref="IInboxStore"/> interface contract.
/// </summary>
public sealed class InboxStoreDapperContractTests : IClassFixture<OracleFixture>
{
    ...
    public InboxStoreDapperContractTests(OracleFixture database)
    {
        _database = database;
