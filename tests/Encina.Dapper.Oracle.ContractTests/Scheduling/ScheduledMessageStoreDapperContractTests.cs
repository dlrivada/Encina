...
namespace Encina.Dapper.Oracle.Tests.Scheduling;
...
public sealed class ScheduledMessageStoreDapperContractTests : IClassFixture<OracleFixture>
{
    private readonly OracleFixture _database;
    private readonly ScheduledMessageStoreDapper _store;

    public ScheduledMessageStoreDapperContractTests(OracleFixture database)
    {
        _database = database;
