...
namespace Encina.Dapper.Oracle.ContractTests.Health;

/// <summary>
/// Contract tests for <see cref="OracleHealthCheck"/> ensuring it follows the IEncinaHealthCheck contract.
/// </summary>
public sealed class OracleHealthCheckContractTests : IEncinaHealthCheckContractTests
{
    ...
    [Fact]
    public void DefaultName_ShouldBeEncinaOracle()
    {
        OracleHealthCheck.DefaultName.Should().Be("encina-oracle");
    }
