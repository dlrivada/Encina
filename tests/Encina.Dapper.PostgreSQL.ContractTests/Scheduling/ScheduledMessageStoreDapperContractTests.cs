...
public sealed class ScheduledMessageStoreDapperContractTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _database;
    private readonly ScheduledMessageStoreDapper _store;

    public ScheduledMessageStoreDapperContractTests(PostgreSqlFixture database)
    {
        _database = database;
