...
namespace Encina.Dapper.PostgreSQL.Tests.Outbox;

/// <summary>
/// Contract integration tests for <see cref="OutboxStoreDapper"/>.
...
public sealed class OutboxStoreDapperContractTests : IClassFixture<PostgreSqlFixture>
{
...
#pragma warning restore CA1859
    ...
    public OutboxStoreDapperContractTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
        ...
        _store = new OutboxStoreDapper(_fixture.CreateConnection()); // Concrete type assigned to interface
    }
