...
public sealed class OutboxStoreADOLoadTests : IClassFixture<SqlServerFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly SqlServerFixture _fixture;
    private readonly OutboxStoreADO _store;

    public OutboxStoreADOLoadTests(SqlServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
