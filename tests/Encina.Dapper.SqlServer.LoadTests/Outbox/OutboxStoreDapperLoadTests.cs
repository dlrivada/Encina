...
public sealed class OutboxStoreDapperLoadTests : IClassFixture<SqlServerFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly SqlServerFixture _fixture;
    private readonly OutboxStoreDapper _store;

    public OutboxStoreDapperLoadTests(SqlServerFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
