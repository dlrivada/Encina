...
/// </summary>
[Trait("Category", "Load")]
public sealed class ScheduledMessageStoreDapperLoadTests : IClassFixture<SqlServerFixture>
{
    private readonly SqlServerFixture _database;
    private readonly ScheduledMessageStoreDapper _store;

    public ScheduledMessageStoreDapperLoadTests(SqlServerFixture database)
    {
        _database = database;
