...
/// <summary>
/// Unit tests for <see cref="Messaging.ContentRouter.ContentRouter"/>.
/// </summary>
public sealed class ContentRouterTests
{
    ...
    public void Constructor_WithNullOptions_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() => new Messaging.ContentRouter.ContentRouter(null!, logger));
    }
    ...
    public void Constructor_WithNullLogger_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() => new Messaging.ContentRouter.ContentRouter(options, null!));
    }
    ...
    private static Messaging.ContentRouter.ContentRouter CreateRouter(ContentRouterOptions? options = null)
    {
        return new Messaging.ContentRouter.ContentRouter(
            options ?? new ContentRouterOptions(),
            NullLogger<Messaging.ContentRouter.ContentRouter>.Instance);
    }
