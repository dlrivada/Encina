...
namespace Encina.Dapper.Oracle.Tests.Sagas;
...
public sealed class SagaStoreDapperPropertyTests : IClassFixture<OracleFixture>
{
    private readonly OracleFixture _fixture;

    public SagaStoreDapperPropertyTests(OracleFixture fixture)
    {
        _fixture = fixture;
