...
namespace Encina.Dapper.Oracle.PropertyTests.Health;

/// <summary>
/// Property-based tests for <see cref="OracleHealthCheck"/> invariants.
/// </summary>
public sealed class OracleHealthCheckPropertyTests
{
    [Fact]
    public void DefaultName_IsAlwaysEncinaOracle()
    {
        Assert.Equal("encina-oracle", OracleHealthCheck.DefaultName);
    }
