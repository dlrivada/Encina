...
/// </summary>
public sealed class InboxStoreDapperPropertyTests : IClassFixture<OracleFixture>
{
    private readonly OracleFixture _database;
    private readonly InboxStoreDapper _store;

    public InboxStoreDapperPropertyTests(OracleFixture database)
    {
        _database = database;
