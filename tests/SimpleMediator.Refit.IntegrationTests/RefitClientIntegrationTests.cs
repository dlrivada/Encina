...
namespace SimpleMediator.Refit.IntegrationTests;

/// <summary>
/// Integration tests for Refit client integration with SimpleMediator.
...
{
    [Fact]
    public async Task EndToEnd_WithSimpleMediator_ShouldResolveClientAndExecute()
    {
        // Arrange
    ...
    public async Task EndToEnd_WithCustomHeaders_ShouldIncludeHeaders()
    {
        ...
        services.AddSimpleMediatorRefitClient<IHttpBinApi>(client =>
        {
