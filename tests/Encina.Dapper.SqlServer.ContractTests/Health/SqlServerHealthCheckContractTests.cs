...
namespace Encina.Dapper.SqlServer.ContractTests.Health;

/// <summary>
/// Contract tests for <see cref="SqlServerHealthCheck"/> ensuring it follows the IEncinaHealthCheck contract.
/// </summary>
public sealed class SqlServerHealthCheckContractTests : IEncinaHealthCheckContractTests
{
    ...
    [Fact]
    public void DefaultName_ShouldBeEncinaSqlserver()
    {
        SqlServerHealthCheck.DefaultName.Should().Be("encina-sqlserver");
    }
