...
namespace Encina.Dapper.SqlServer.Tests.Inbox;
...
/// </summary>
public sealed class InboxStoreDapperContractTests : IClassFixture<SqlServerFixture>
{
    ...
    public InboxStoreDapperContractTests(SqlServerFixture database)
    {
        _database = database;
