...
/// <summary>
/// Integration tests for sharded repository CRUD operations using MongoDB.
/// </summary>
...
public sealed class ShardedRepositoryCrudTests : IAsyncLifetime
{
    ...
    public ShardedRepositoryCrudTests(ShardedMongoDbFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        // Core sharding with app-level routing
        ...
        // MongoDB sharding (app-level mode)
