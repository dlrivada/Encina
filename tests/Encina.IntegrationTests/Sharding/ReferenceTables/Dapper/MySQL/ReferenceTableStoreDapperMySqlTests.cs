...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.Dapper.MySQL;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreDapper"/> using MySQL.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-Dapper-MySQL")]
[Trait("Category", "Integration")]
[Trait("Database", "MySQL")]
public sealed class ReferenceTableStoreDapperMySqlTests : IAsyncLifetime
{
    private readonly ShardedMySqlFixture _fixture;

    public ReferenceTableStoreDapperMySqlTests(ShardedMySqlFixture fixture)
    {
        _fixture = fixture;
    }
