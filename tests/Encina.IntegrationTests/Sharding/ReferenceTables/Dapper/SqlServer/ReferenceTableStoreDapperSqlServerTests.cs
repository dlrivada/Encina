using Encina.Dapper.SqlServer.Sharding.ReferenceTables;
...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.Dapper.SqlServer;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreDapper"/> using SQL Server.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-Dapper-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Database", "SqlServer")]
public sealed class ReferenceTableStoreDapperSqlServerTests : IAsyncLifetime
{
    private readonly ShardedSqlServerFixture _fixture;

    public ReferenceTableStoreDapperSqlServerTests(ShardedSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
