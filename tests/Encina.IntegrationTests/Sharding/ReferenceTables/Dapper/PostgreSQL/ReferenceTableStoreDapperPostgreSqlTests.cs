...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.Dapper.PostgreSQL;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreDapper"/> using PostgreSQL.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-Dapper-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Database", "PostgreSQL")]
public sealed class ReferenceTableStoreDapperPostgreSqlTests : IAsyncLifetime
{
    private readonly ShardedPostgreSqlFixture _fixture;

    public ReferenceTableStoreDapperPostgreSqlTests(ShardedPostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
