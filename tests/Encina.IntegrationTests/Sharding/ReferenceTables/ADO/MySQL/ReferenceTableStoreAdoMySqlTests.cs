...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.ADO.MySQL;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreADO"/> using MySQL.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-ADO-MySQL")]
[Trait("Category", "Integration")]
[Trait("Database", "MySQL")]
public sealed class ReferenceTableStoreAdoMySqlTests : IAsyncLifetime
{
    private readonly ShardedMySqlFixture _fixture;

    public ReferenceTableStoreAdoMySqlTests(ShardedMySqlFixture fixture)
    {
        _fixture = fixture;
    }
