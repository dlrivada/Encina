...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.ADO.Sqlite;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreADO"/> using SQLite.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-ADO-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Database", "SQLite")]
public sealed class ReferenceTableStoreAdoSqliteTests : IAsyncLifetime
{
    private readonly ShardedSqliteFixture _fixture;

    public ReferenceTableStoreAdoSqliteTests(ShardedSqliteFixture fixture)
    {
        _fixture = fixture;
    }
