...
namespace Encina.IntegrationTests.Sharding.ReferenceTables.ADO.PostgreSQL;

/// <summary>
/// Integration tests for <see cref="ReferenceTableStoreADO"/> using PostgreSQL.
/// Verifies upsert, read, hash, and cross-shard replication end-to-end.
/// </summary>
[Collection("Sharding-ADO-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Database", "PostgreSQL")]
public sealed class ReferenceTableStoreAdoPostgreSqlTests : IAsyncLifetime
{
    private readonly ShardedPostgreSqlFixture _fixture;

    public ReferenceTableStoreAdoPostgreSqlTests(ShardedPostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
