...
using Encina.Dapper.SqlServer.Sharding;
...
namespace Encina.IntegrationTests.Sharding.Dapper.SqlServer;

/// <summary>
/// Integration tests verifying routing consistency and data isolation using Dapper with SQL Server.
/// </summary>
...
public sealed class ShardedRoutingVerificationTests : IAsyncLifetime
{
    ...
    public ShardedRoutingVerificationTests(ShardedSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        using var connection = (SqlConnection)_fixture.CreateConnection(shardId);
