...
/// <summary>
/// Integration tests for sharded repository CRUD operations using Dapper with SQL Server.
/// </summary>
...
public sealed class ShardedRepositoryCrudTests : IAsyncLifetime
{
    ...
    public ShardedRepositoryCrudTests(ShardedSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
