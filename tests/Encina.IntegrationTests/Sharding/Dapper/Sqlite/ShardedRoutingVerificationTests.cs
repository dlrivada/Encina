...
using Encina.Dapper.Sqlite.Sharding;
...
namespace Encina.IntegrationTests.Sharding.Dapper.Sqlite;

/// <summary>
/// Integration tests verifying routing consistency and data isolation using Dapper with SQLite.
/// </summary>
...
public sealed class ShardedRoutingVerificationTests : IAsyncLifetime
{
    ...
    {
        using var connection = (SqliteConnection)_fixture.CreateConnection(shardId);
