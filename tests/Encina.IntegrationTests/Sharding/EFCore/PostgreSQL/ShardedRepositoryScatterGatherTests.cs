...
/// <summary>
/// Integration tests for sharded repository scatter-gather operations using EF Core with PostgreSQL.
/// </summary>
[Collection("Sharding-EFCore-PostgreSQL")]
...
public sealed class ShardedRepositoryScatterGatherTests : IAsyncLifetime
{
    ...
    public ShardedRepositoryScatterGatherTests(ShardedPostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        services.AddEncinaEFCoreShardingPostgreSql<ShardedTestPostgreSqlDbContext, ShardedTestEntity, string>();
    ...
    public async Task QueryAllShardsAsync_ShouldReturnResultsFromAllShards()
    {
        ...
        var contextFactory = scope.ServiceProvider.GetRequiredService<IShardedDbContextFactory<ShardedTestPostgreSqlDbContext>>();
