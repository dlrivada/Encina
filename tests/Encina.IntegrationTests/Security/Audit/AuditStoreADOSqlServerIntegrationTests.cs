...
/// <summary>
/// Integration tests for <see cref="AuditStoreADO"/> with SQL Server.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "SqlServer")]
[Collection("ADO-SqlServer")]
public class AuditStoreADOSqlServerIntegrationTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private IDbConnection _connection = null!;
    private AuditStoreADO _store = null!;

    public AuditStoreADOSqlServerIntegrationTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
