...
public sealed class DPIAStoreEFCoreSqliteTests : IAsyncLifetime
{
    ...
    public DPIAStoreEFCoreSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    private sealed class DPIATestDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // SQLite does not support DateTimeOffset in ORDER BY / WHERE.
            // Convert all DateTimeOffset properties to TEXT (ISO 8601) for SQLite compatibility.
                ...
                foreach (var property in entityType.GetProperties())
                {
                    if (property.ClrType == typeof(DateTimeOffset))
                        property.SetValueConverter(
                            new Microsoft.EntityFrameworkCore.Storage.ValueConversion.DateTimeOffsetToStringConverter());
