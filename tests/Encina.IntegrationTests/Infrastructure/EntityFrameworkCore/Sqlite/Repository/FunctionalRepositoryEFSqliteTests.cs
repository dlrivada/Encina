...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.Repository;

/// <summary>
/// SQLite-specific integration tests for <see cref="FunctionalRepositoryEF{TEntity, TId}"/>.
/// Uses in-memory SQLite database.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
[Collection("EFCore-Sqlite")]
public sealed class FunctionalRepositoryEFSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public FunctionalRepositoryEFSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
