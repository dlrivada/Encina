...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.BulkOperations;

/// <summary>
/// SQLite-specific integration tests for <see cref="BulkOperationsEFSqlite{TEntity}"/>.
/// Tests verify actual bulk operations against a real SQLite in-memory database.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
[Trait("Feature", "BulkOperations")]
[Collection("EFCore-Sqlite")]
public sealed class BulkOperationsEFSqliteTests : IAsyncLifetime
{
    ...
    public BulkOperationsEFSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
