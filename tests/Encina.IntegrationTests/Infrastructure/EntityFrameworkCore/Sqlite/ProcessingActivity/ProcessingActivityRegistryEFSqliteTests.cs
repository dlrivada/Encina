...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.ProcessingActivity;

[Collection("EFCore-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.Sqlite")]
public sealed class ProcessingActivityRegistryEFSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public ProcessingActivityRegistryEFSqliteTests(EFCoreSqliteFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryEFSqliteTests),
