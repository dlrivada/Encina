...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.Sagas;

/// <summary>
/// SQLite-specific integration tests for <see cref="SagaStoreEF"/>.
/// Uses in-memory SQLite database.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
[Collection("EFCore-Sqlite")]
public sealed class SagaStoreEFSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public SagaStoreEFSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
