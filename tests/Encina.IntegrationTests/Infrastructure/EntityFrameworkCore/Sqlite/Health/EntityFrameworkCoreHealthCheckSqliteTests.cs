...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.Health;

/// <summary>
/// SQLite-specific integration tests for <see cref="EntityFrameworkCoreHealthCheck"/>.
/// Uses in-memory SQLite database.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
[Collection("EFCore-Sqlite")]
public sealed class EntityFrameworkCoreHealthCheckSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public EntityFrameworkCoreHealthCheckSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task CheckHealthAsync_WithCustomName_UsesCustomName()
    {
        ...
        var options = new ProviderHealthCheckOptions { Name = "my-custom-efcore-sqlite" };
        using var serviceProvider = CreateServiceProvider(context);
        ...
        // Assert
        healthCheck.Name.ShouldBe("my-custom-efcore-sqlite");
        result.Status.ShouldBe(HealthStatus.Healthy);
    }
