...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.LawfulBasis;

[Collection("EFCore-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.Sqlite")]
public sealed class LawfulBasisRegistryEFSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public LawfulBasisRegistryEFSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
