...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Sqlite.UnitOfWork;

/// <summary>
/// SQLite-specific integration tests for <see cref="UnitOfWorkEF"/>.
/// Uses in-memory SQLite database.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
[Collection("EFCore-Sqlite")]
public sealed class UnitOfWorkEFSqliteTests : IAsyncLifetime
{
    private readonly EFCoreSqliteFixture _fixture;

    public UnitOfWorkEFSqliteTests(EFCoreSqliteFixture fixture)
    {
        _fixture = fixture;
    }
