...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.MySQL.LawfulBasis;

[Collection("EFCore-MySQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.MySQL")]
public sealed class LawfulBasisRegistryEFMySqlTests : IAsyncLifetime
{
    private readonly EFCoreMySqlFixture _fixture;

    public LawfulBasisRegistryEFMySqlTests(EFCoreMySqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        RequestType = requestType ?? typeof(LawfulBasisRegistryEFMySqlTests),
        Basis = basis,
