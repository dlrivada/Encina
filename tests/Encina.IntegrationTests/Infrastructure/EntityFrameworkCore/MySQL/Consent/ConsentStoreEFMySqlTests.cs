...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.MySQL.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreEF"/> with MySQL.
/// Tests the EF Core implementation of the consent store using a real MySQL database via Docker.
/// </summary>
[Collection("EFCore-MySQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.MySQL")]
public sealed class ConsentStoreEFMySqlTests : IAsyncLifetime
{
    private readonly EFCoreMySqlFixture _fixture;

    public ConsentStoreEFMySqlTests(EFCoreMySqlFixture fixture)
    {
        _fixture = fixture;
    }
