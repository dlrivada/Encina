...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.MySQL.IdGeneration;

/// <summary>
/// EF Core integration tests for ID generation value converters with MySQL.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.MySQL")]
[Collection("EFCore-MySQL")]
public sealed class IdGenerationConverterMySqlTests : IAsyncLifetime
{
    private readonly EFCoreMySqlFixture _fixture;

    public IdGenerationConverterMySqlTests(EFCoreMySqlFixture fixture)
    {
        _fixture = fixture;
    }
