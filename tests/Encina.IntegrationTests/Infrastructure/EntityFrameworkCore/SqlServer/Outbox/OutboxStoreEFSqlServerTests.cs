...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.SqlServer.Outbox;

/// <summary>
/// SQL Server-specific integration tests for <see cref="OutboxStoreEF"/>.
/// Uses real SQL Server database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "SqlServer")]
[Collection("EFCore-SqlServer")]
public sealed class OutboxStoreEFSqlServerTests : IAsyncLifetime
{
    private readonly EFCoreSqlServerFixture _fixture;

    public OutboxStoreEFSqlServerTests(EFCoreSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
