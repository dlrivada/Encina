...
public sealed class LawfulBasisRegistryEFSqlServerTests : IAsyncLifetime
{
    private readonly EFCoreSqlServerFixture _fixture;

    public LawfulBasisRegistryEFSqlServerTests(EFCoreSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        RequestType = requestType ?? typeof(LawfulBasisRegistryEFSqlServerTests),
        Basis = basis,
