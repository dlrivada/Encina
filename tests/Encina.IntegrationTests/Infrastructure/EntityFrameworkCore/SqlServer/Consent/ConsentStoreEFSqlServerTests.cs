...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.SqlServer.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreEF"/> with SQL Server.
/// Tests the EF Core implementation of the consent store using a real SQL Server database via Docker.
/// </summary>
[Collection("EFCore-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.SqlServer")]
public sealed class ConsentStoreEFSqlServerTests : IAsyncLifetime
{
    private readonly EFCoreSqlServerFixture _fixture;

    public ConsentStoreEFSqlServerTests(EFCoreSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
