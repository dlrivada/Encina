...
/// <summary>
/// SQL Server-specific integration tests for EF Core multi-tenancy support.
/// Tests global query filters, automatic tenant assignment, and tenant isolation.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "SqlServer")]
[Collection("EFCore-SqlServer")]
public sealed class TenancyEFSqlServerTests : IAsyncLifetime
{
    ...
    public TenancyEFSqlServerTests(EFCoreSqlServerFixture fixture)
    {
        _fixture = fixture;
    }
