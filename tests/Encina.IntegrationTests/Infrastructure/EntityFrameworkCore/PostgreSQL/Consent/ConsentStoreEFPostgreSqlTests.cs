...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.PostgreSQL.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreEF"/> with PostgreSQL.
/// Tests the EF Core implementation of the consent store using a real PostgreSQL database via Docker.
/// </summary>
[Collection("EFCore-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "EFCore.PostgreSQL")]
public sealed class ConsentStoreEFPostgreSqlTests : IAsyncLifetime
{
    private readonly EFCorePostgreSqlFixture _fixture;

    public ConsentStoreEFPostgreSqlTests(EFCorePostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        // Arrange
        await using var context = _fixture.CreateDbContext<ConsentTestPostgreSqlDbContext>();
    ...
    public async Task RecordConsentAsync_ShouldPersistAllProperties()
    {
        ...
        await using var verifyContext = _fixture.CreateDbContext<ConsentTestPostgreSqlDbContext>();
