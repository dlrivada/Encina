...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.PostgreSQL.ImmutableUpdates;

/// <summary>
/// PostgreSQL-specific integration tests for <see cref="ImmutableUpdateExtensions"/>.
/// Requires running PostgreSQL instance via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "PostgreSQL")]
[Collection("EFCore-PostgreSQL")]
public sealed class ImmutableUpdatesPostgreSqlTests : IAsyncLifetime
{
    private readonly EFCorePostgreSqlFixture _fixture;

    public ImmutableUpdatesPostgreSqlTests(EFCorePostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
