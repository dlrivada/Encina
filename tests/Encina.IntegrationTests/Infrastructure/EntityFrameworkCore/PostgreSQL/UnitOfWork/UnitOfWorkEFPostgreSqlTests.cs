...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.PostgreSQL.UnitOfWork;
...
public sealed class UnitOfWorkEFPostgreSqlTests : IAsyncLifetime
{
    private readonly EFCorePostgreSqlFixture _fixture;

    public UnitOfWorkEFPostgreSqlTests(EFCorePostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
