...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.PostgreSQL.BulkOperations;

/// <summary>
/// PostgreSQL-specific integration tests for <see cref="BulkOperationsEFPostgreSql{TEntity}"/>.
/// Tests verify actual bulk operations against a real PostgreSQL database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "PostgreSQL")]
[Trait("Feature", "BulkOperations")]
[Collection("EFCore-PostgreSQL")]
public sealed class BulkOperationsEFPostgreSqlTests : IAsyncLifetime
{
