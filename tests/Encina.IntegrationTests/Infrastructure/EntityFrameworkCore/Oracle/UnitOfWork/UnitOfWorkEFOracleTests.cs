...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Oracle.UnitOfWork;

/// <summary>
/// Oracle-specific integration tests for <see cref="UnitOfWorkEF"/>.
/// Uses real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Oracle")]
[Collection("EFCore-Oracle")]
public sealed class UnitOfWorkEFOracleTests : IAsyncLifetime
{
    private readonly EFCoreOracleFixture _fixture;

    public UnitOfWorkEFOracleTests(EFCoreOracleFixture fixture)
    {
        _fixture = fixture;
    }
