...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Oracle.Sagas;

/// <summary>
/// Oracle-specific integration tests for <see cref="SagaStoreEF"/>.
/// Uses real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Oracle")]
[Collection("EFCore-Oracle")]
public sealed class SagaStoreEFOracleTests : IAsyncLifetime
{
    private readonly EFCoreOracleFixture _fixture;

    public SagaStoreEFOracleTests(EFCoreOracleFixture fixture)
    {
        _fixture = fixture;
    }
