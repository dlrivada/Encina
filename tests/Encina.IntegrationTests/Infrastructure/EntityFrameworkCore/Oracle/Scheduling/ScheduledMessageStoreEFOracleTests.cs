...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Oracle.Scheduling;

/// <summary>
/// Oracle-specific integration tests for <see cref="ScheduledMessageStoreEF"/>.
/// Uses real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Oracle")]
[Collection("EFCore-Oracle")]
public sealed class ScheduledMessageStoreEFOracleTests : IAsyncLifetime
{
    private readonly EFCoreOracleFixture _fixture;

    public ScheduledMessageStoreEFOracleTests(EFCoreOracleFixture fixture)
    {
        _fixture = fixture;
    }
