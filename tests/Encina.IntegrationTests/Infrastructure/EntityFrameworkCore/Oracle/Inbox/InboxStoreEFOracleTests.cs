...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Oracle.Inbox;

/// <summary>
/// Oracle-specific integration tests for <see cref="InboxStoreEF"/>.
/// Uses real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Oracle")]
[Collection("EFCore-Oracle")]
public sealed class InboxStoreEFOracleTests : IAsyncLifetime
{
    private readonly EFCoreOracleFixture _fixture;

    public InboxStoreEFOracleTests(EFCoreOracleFixture fixture)
    {
        _fixture = fixture;
    }
