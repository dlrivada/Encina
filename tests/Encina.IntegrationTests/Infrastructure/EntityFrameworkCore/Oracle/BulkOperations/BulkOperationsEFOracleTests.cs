...
namespace Encina.IntegrationTests.Infrastructure.EntityFrameworkCore.Oracle.BulkOperations;

/// <summary>
/// Oracle-specific integration tests for <see cref="BulkOperationsEFOracle{TEntity}"/>.
/// Tests verify actual bulk operations against a real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Oracle")]
[Trait("Feature", "BulkOperations")]
[Collection("EFCore-Oracle")]
public sealed class BulkOperationsEFOracleTests : IAsyncLifetime
{
    ...
    public BulkOperationsEFOracleTests(EFCoreOracleFixture fixture)
    {
        _fixture = fixture;
    }
