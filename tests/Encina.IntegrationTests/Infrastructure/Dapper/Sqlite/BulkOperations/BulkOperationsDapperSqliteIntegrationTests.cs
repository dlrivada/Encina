...
namespace Encina.IntegrationTests.Infrastructure.Dapper.Sqlite.BulkOperations;

/// <summary>
/// Integration tests for <see cref="BulkOperationsDapper{TEntity, TId}"/> with real SQLite.
...
public sealed class BulkOperationsDapperSqliteIntegrationTests : IAsyncLifetime
{
    ...
    public BulkOperationsDapperSqliteIntegrationTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    }
