...
namespace Encina.IntegrationTests.Infrastructure.Dapper.PostgreSQL.BulkOperations;

/// <summary>
/// Integration tests for <see cref="BulkOperationsDapper{TEntity, TId}"/> with real PostgreSQL.
...
public sealed class BulkOperationsDapperPostgreSQLIntegrationTests : IClassFixture<PostgreSqlFixture>, IAsyncLifetime
{
    ...
    public BulkOperationsDapperPostgreSQLIntegrationTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
