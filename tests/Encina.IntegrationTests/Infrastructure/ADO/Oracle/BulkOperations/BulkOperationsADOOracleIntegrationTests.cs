...
using Encina.ADO.Oracle.BulkOperations;
...
namespace Encina.IntegrationTests.Infrastructure.ADO.Oracle.BulkOperations;

/// <summary>
/// Integration tests for <see cref="BulkOperationsOracle{TEntity, TId}"/> with real Oracle.
...
/// and bulk DELETE operations work correctly against a real Oracle database.
...
public sealed class BulkOperationsADOOracleIntegrationTests : IClassFixture<OracleFixture>, IAsyncLifetime
{
    private readonly OracleFixture _fixture;
    private IDbConnection _connection = null!;
    private BulkOperationsOracle<BulkTestOrder, Guid> _bulkOps = null!;

    public BulkOperationsADOOracleIntegrationTests(OracleFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async Task InitializeAsync()
    {
        ...
        _bulkOps = new BulkOperationsOracle<BulkTestOrder, Guid>(_connection, mapping);
    }
