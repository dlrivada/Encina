using Encina.ADO.MySQL.LawfulBasis;
using Encina.Compliance.GDPR;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.ADO.MySQL.LawfulBasis;

[Collection("ADO-MySQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.MySQL")]
public sealed class LawfulBasisRegistryADOMySqlTests : IAsyncLifetime
{
    private readonly MySqlFixture _fixture;
    private LawfulBasisRegistryADO _store = null!;

    public LawfulBasisRegistryADOMySqlTests(MySqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        RequestType = requestType ?? typeof(LawfulBasisRegistryADOMySqlTests),
        Basis = basis,
