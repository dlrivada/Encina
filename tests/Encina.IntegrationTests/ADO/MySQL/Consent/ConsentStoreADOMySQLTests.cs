using Encina.ADO.MySQL.Consent;
using Encina.Compliance.Consent;
using Encina.TestInfrastructure.Fixtures;

using LanguageExt;

namespace Encina.IntegrationTests.ADO.MySQL.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreADO"/> with MySQL.
/// Tests the ADO.NET implementation of the consent store using a real MySQL database via Testcontainers.
/// </summary>
[Collection("ADO-MySQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.MySQL")]
public sealed class ConsentStoreADOMySQLTests : IAsyncLifetime
{
    private readonly MySqlFixture _fixture;
    private ConsentStoreADO _store = null!;

    public ConsentStoreADOMySQLTests(MySqlFixture fixture)
    {
        _fixture = fixture;
    }
