...
namespace Encina.IntegrationTests.ADO.MySQL.Tenancy;

/// <summary>
/// Integration tests for multi-tenancy support in ADO.NET MySQL provider.
...
public class TenancyADOIntegrationTests : IAsyncLifetime
{
    ...
    public TenancyADOIntegrationTests(MySqlFixture fixture)
    {
        _fixture = fixture;
    }
