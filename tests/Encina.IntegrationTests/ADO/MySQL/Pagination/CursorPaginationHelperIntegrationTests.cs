...
namespace Encina.IntegrationTests.ADO.MySQL.Pagination;

/// <summary>
/// Integration tests for <see cref="CursorPaginationHelper{TEntity}"/> using real MySQL.
/// </summary>
...
#pragma warning restore CA1001
{
    ...
    public CursorPaginationHelperIntegrationTests(MySqlFixture fixture)
    {
        _fixture = fixture;
    }
