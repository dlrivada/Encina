...
public sealed class ProcessingActivityRegistryADOMySqlTests : IAsyncLifetime
{
    private readonly MySqlFixture _fixture;
    private ProcessingActivityRegistryADO _store = null!;

    public ProcessingActivityRegistryADOMySqlTests(MySqlFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryADOMySqlTests),
