...
namespace Encina.IntegrationTests.ADO.PostgreSQL.ReadWriteSeparation;

/// <summary>
/// Integration tests for read/write separation in ADO.NET PostgreSQL provider.
...
public class ReadWriteSeparationADOIntegrationTests : ReadWriteSeparationTestsBase<PostgreSqlFixture>
{
    ...
    public override async ValueTask InitializeAsync()
    {
        ...
        await using var connection = (NpgsqlConnection)_fixture.CreateConnection();
