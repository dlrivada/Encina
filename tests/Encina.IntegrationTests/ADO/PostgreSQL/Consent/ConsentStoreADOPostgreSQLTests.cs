using Encina.ADO.PostgreSQL.Consent;
using Encina.Compliance.Consent;
using Encina.TestInfrastructure.Fixtures;

using LanguageExt;

namespace Encina.IntegrationTests.ADO.PostgreSQL.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreADO"/> with PostgreSQL.
/// Tests the ADO.NET implementation of the consent store using a real PostgreSQL database via Testcontainers.
/// </summary>
[Collection("ADO-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.PostgreSQL")]
public sealed class ConsentStoreADOPostgreSQLTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private ConsentStoreADO _store = null!;

    public ConsentStoreADOPostgreSQLTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
