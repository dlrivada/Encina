using Encina.ADO.PostgreSQL.LawfulBasis;
using Encina.Compliance.GDPR;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.ADO.PostgreSQL.LawfulBasis;

[Collection("ADO-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.PostgreSQL")]
public sealed class LawfulBasisRegistryADOPostgreSqlTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private LawfulBasisRegistryADO _store = null!;

    public LawfulBasisRegistryADOPostgreSqlTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    private static LawfulBasisRegistration CreateRegistration(
        ...
        {
            RequestType = requestType ?? typeof(LawfulBasisRegistryADOPostgreSqlTests),
            Basis = basis,
