...
public sealed class LIAStoreADOPostgreSqlTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private LIAStoreADO _store = null!;

    public LIAStoreADOPostgreSqlTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    public async ValueTask InitializeAsync()
    {
        ...
        _store = new LIAStoreADO(_fixture.ConnectionString);
    }
