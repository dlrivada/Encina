using Encina.ADO.PostgreSQL.Pagination;
...
namespace Encina.IntegrationTests.ADO.PostgreSQL.Pagination;

/// <summary>
/// Integration tests for <see cref="CursorPaginationHelper{TEntity}"/> using real PostgreSQL.
/// </summary>
...
#pragma warning restore CA1001
{
    ...
    public CursorPaginationHelperIntegrationTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
