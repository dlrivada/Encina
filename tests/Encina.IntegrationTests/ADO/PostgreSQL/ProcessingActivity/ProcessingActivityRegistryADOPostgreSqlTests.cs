using Encina.ADO.PostgreSQL.ProcessingActivity;
using Encina.Compliance.GDPR;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.ADO.PostgreSQL.ProcessingActivity;

[Collection("ADO-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.PostgreSQL")]
public sealed class ProcessingActivityRegistryADOPostgreSqlTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private ProcessingActivityRegistryADO _store = null!;

    public ProcessingActivityRegistryADOPostgreSqlTests(PostgreSqlFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryADOPostgreSqlTests),
