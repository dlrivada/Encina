...
namespace Encina.IntegrationTests.ADO.PostgreSQL.Inbox;
...
public sealed class InboxStoreADOTests : IClassFixture<PostgreSqlFixture>
{
    ...
    public InboxStoreADOTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
