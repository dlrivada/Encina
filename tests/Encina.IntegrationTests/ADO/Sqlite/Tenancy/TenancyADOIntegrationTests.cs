...
namespace Encina.IntegrationTests.ADO.Sqlite.Tenancy;

/// <summary>
/// Integration tests for multi-tenancy support in ADO.NET SQLite provider.
/// Tests automatic tenant filtering, tenant ID assignment, and cross-tenant isolation.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Database", "Sqlite")]
public class TenancyADOIntegrationTests : IClassFixture<SqliteFixture>
{
    ...
    public TenancyADOIntegrationTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    ...
    private async Task ClearDataAsync()
    {
        ...
        {
            await TenancySchema.ClearTenancyDataAsync(sqliteConnection);
        }
    }
