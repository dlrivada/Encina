using Encina.ADO.Sqlite.ProcessingActivity;
using Encina.Compliance.GDPR;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.ADO.Sqlite.ProcessingActivity;

[Collection("ADO-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.Sqlite")]
public sealed class ProcessingActivityRegistryADOSqliteTests : IAsyncLifetime
{
    private readonly SqliteFixture _fixture;
    private ProcessingActivityRegistryADO _store = null!;

    public ProcessingActivityRegistryADOSqliteTests(SqliteFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryADOSqliteTests),
