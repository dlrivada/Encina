...
namespace Encina.IntegrationTests.ADO.Oracle.Inbox;

/// <summary>
/// Integration tests for <see cref="InboxStoreADO"/>.
/// Tests all public methods with various scenarios using real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.Oracle")]
public sealed class InboxStoreADOTests : IClassFixture<OracleFixture>
{
    ...
    public InboxStoreADOTests(OracleFixture fixture)
    {
        _fixture = fixture;
