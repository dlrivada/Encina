...
namespace Encina.IntegrationTests.ADO.Oracle.Sagas;

/// <summary>
/// Integration tests for <see cref="SagaStoreADO"/>.
/// Tests against real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.Oracle")]
public sealed class SagaStoreADOTests : IClassFixture<OracleFixture>
{
    private readonly OracleFixture _fixture;
    private readonly SagaStoreADO _store;

    public SagaStoreADOTests(OracleFixture fixture)
    {
        _fixture = fixture;
