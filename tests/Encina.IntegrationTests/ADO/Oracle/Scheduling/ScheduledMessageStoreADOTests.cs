...
namespace Encina.IntegrationTests.ADO.Oracle.Scheduling;

/// <summary>
/// Integration tests for <see cref="ScheduledMessageStoreADO"/>.
/// Tests against real Oracle database via Testcontainers.
/// </summary>
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.Oracle")]
public sealed class ScheduledMessageStoreADOTests : IClassFixture<OracleFixture>
{
    private readonly OracleFixture _fixture;
    private readonly ScheduledMessageStoreADO _store;

    public ScheduledMessageStoreADOTests(OracleFixture fixture)
    {
        _fixture = fixture;
