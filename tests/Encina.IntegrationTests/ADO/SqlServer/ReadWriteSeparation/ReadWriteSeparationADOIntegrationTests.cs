...
namespace Encina.IntegrationTests.ADO.SqlServer.ReadWriteSeparation;

/// <summary>
/// Integration tests for read/write separation in ADO.NET SQL Server provider.
...
public class ReadWriteSeparationADOIntegrationTests : ReadWriteSeparationTestsBase<SqlServerFixture>
{
    ...
    public override async ValueTask InitializeAsync()
    {
        ...
        // Note: For true integration testing with replicas, you would configure different endpoints
    ...
    #region Additional SqlServer-Specific Tests
