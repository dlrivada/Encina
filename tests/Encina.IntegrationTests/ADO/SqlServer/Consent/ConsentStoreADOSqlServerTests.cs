using Encina.ADO.SqlServer.Consent;
using Encina.Compliance.Consent;
using Encina.TestInfrastructure.Fixtures;

using LanguageExt;

namespace Encina.IntegrationTests.ADO.SqlServer.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreADO"/> with SQL Server.
/// Tests the ADO.NET implementation of the consent store using a real SQL Server database via Testcontainers.
/// </summary>
[Collection("ADO-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Provider", "ADO.SqlServer")]
public sealed class ConsentStoreADOSqlServerTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private ConsentStoreADO _store = null!;

    public ConsentStoreADOSqlServerTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
