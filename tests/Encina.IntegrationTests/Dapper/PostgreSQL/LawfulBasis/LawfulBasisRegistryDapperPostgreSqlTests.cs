using Encina.Dapper.PostgreSQL.LawfulBasis;
using Encina.Compliance.GDPR;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.PostgreSQL.LawfulBasis;

[Collection("Dapper-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.PostgreSQL")]
public sealed class LawfulBasisRegistryDapperPostgreSqlTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private LawfulBasisRegistryDapper _store = null!;

    public LawfulBasisRegistryDapperPostgreSqlTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    {
        RequestType = requestType ?? typeof(LawfulBasisRegistryDapperPostgreSqlTests),
        Basis = basis,
