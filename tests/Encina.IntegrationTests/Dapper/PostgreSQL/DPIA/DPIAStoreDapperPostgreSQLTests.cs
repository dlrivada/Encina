...
using Encina.Dapper.PostgreSQL.DPIA;
using Encina.TestInfrastructure.Fixtures;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.PostgreSQL.DPIA;

[Collection("Dapper-PostgreSQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.PostgreSQL")]
public sealed class DPIAStoreDapperPostgreSQLTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private DPIAStoreDapper _store = null!;
    private DPIAAuditStoreDapper _auditStore = null!;

    public DPIAStoreDapperPostgreSQLTests(PostgreSqlFixture fixture)
    {
        _fixture = fixture;
    }
