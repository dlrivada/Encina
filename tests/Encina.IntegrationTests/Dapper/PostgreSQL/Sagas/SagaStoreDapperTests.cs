...
namespace Encina.IntegrationTests.Dapper.PostgreSQL.Sagas;
...
public sealed class SagaStoreDapperTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _database;
    private readonly SagaStoreDapper _store;

    public SagaStoreDapperTests(PostgreSqlFixture database)
    {
        _database = database;
