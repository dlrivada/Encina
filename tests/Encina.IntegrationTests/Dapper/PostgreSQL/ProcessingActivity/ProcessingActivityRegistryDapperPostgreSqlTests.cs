...
public sealed class ProcessingActivityRegistryDapperPostgreSqlTests : IAsyncLifetime
{
    private readonly PostgreSqlFixture _fixture;
    private ProcessingActivityRegistryDapper _store = null!;

    public ProcessingActivityRegistryDapperPostgreSqlTests(PostgreSqlFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryDapperPostgreSqlTests),
