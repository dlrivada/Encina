...
using Encina.Dapper.SqlServer.DPIA;
using Encina.TestInfrastructure.Fixtures;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.SqlServer.DPIA;

[Collection("Dapper-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.SqlServer")]
public sealed class DPIAStoreDapperSqlServerTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private DPIAStoreDapper _store = null!;
    private DPIAAuditStoreDapper _auditStore = null!;

    public DPIAStoreDapperSqlServerTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
