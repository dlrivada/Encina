...
namespace Encina.IntegrationTests.Dapper.SqlServer.ProcessingActivity;

[Collection("Dapper-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.SqlServer")]
public sealed class ProcessingActivityRegistryDapperSqlServerTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private ProcessingActivityRegistryDapper _store = null!;

    public ProcessingActivityRegistryDapperSqlServerTests(SqlServerFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryDapperSqlServerTests),
