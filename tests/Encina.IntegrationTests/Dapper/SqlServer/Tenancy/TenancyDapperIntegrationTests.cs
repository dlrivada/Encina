...
namespace Encina.IntegrationTests.Dapper.SqlServer.Tenancy;

/// <summary>
/// Integration tests for multi-tenancy support in Dapper SQL Server provider.
...
public class TenancyDapperIntegrationTests : IAsyncLifetime
{
    ...
    public TenancyDapperIntegrationTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
