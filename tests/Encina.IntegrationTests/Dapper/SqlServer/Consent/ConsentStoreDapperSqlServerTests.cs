...
/// <summary>
/// Integration tests for <see cref="ConsentStoreDapper"/> with SQL Server.
/// Tests the Dapper implementation of the consent store using a real SQL Server database via Testcontainers.
/// </summary>
[Collection("Dapper-SqlServer")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.SqlServer")]
public sealed class ConsentStoreDapperSqlServerTests : IAsyncLifetime
{
    private readonly SqlServerFixture _fixture;
    private ConsentStoreDapper _store = null!;

    public ConsentStoreDapperSqlServerTests(SqlServerFixture fixture)
    {
        _fixture = fixture;
    }
