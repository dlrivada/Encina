...
/// <summary>
/// Integration tests for <see cref="ConsentStoreDapper"/> with SQLite.
/// Tests the Dapper implementation of the consent store using a real SQLite in-memory database.
/// </summary>
[Collection("Dapper-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.Sqlite")]
public sealed class ConsentStoreDapperSqliteTests : IAsyncLifetime
{
    private readonly SqliteFixture _fixture;
    private ConsentStoreDapper _store = null!;

    public ConsentStoreDapperSqliteTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    }
