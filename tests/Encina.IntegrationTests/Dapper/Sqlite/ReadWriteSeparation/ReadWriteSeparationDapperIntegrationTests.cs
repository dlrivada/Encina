...
using Encina.Dapper.Sqlite.ReadWriteSeparation;
...
namespace Encina.IntegrationTests.Dapper.Sqlite.ReadWriteSeparation;

/// <summary>
/// Integration tests for read/write separation in Dapper SQLite provider.
...
public class ReadWriteSeparationDapperIntegrationTests : ReadWriteSeparationTestsBase<SqliteFixture>
{
    ...
    public ReadWriteSeparationDapperIntegrationTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    /// <inheritdoc />
    protected override string ProviderName => "Dapper.Sqlite";
    ...
    #region Additional Dapper SQLite-Specific Tests
