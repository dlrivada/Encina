...
using Encina.Dapper.Sqlite.DPIA;
using Encina.TestInfrastructure.Fixtures;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.Sqlite.DPIA;

[Collection("Dapper-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.Sqlite")]
public sealed class DPIAStoreDapperSqliteTests : IAsyncLifetime
{
    private readonly SqliteFixture _fixture;
    private DPIAStoreDapper _store = null!;
    private DPIAAuditStoreDapper _auditStore = null!;

    public DPIAStoreDapperSqliteTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    }
