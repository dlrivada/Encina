...
using Encina.Dapper.Sqlite.Modules;
using Encina.Modules.Isolation;
using Encina.TestInfrastructure.Fixtures;
using Microsoft.Data.Sqlite;
using Shouldly;

namespace Encina.IntegrationTests.Dapper.Sqlite.ModuleIsolation;

/// <summary>
/// Integration tests for module isolation support in Dapper SQLite provider.
/// </summary>
/// <remarks>
/// <para>
...
public class ModuleIsolationDapperIntegrationTests : IAsyncLifetime
{
    ...
    [Fact]
    public void ModuleAwareConnectionFactory_CreatesDbConnection_ViaCreateDbConnection()
    {
        // Arrange
        var factory = CreateModuleAwareConnectionFactory("Orders");
    ...
    #region Connection Factory Integration Tests

    [Fact]
    public async Task ConnectionFactory_CanExecuteValidQuery()
    {
        // Arrange
        var factory = CreateModuleAwareConnectionFactory("Orders");
        await using var connection = factory.CreateDbConnection();
        await connection.OpenAsync();
    ...
    [Fact]
    public async Task ConnectionFactory_ThrowsOnCrossModuleAccess()
    {
        // Arrange
        var factory = CreateModuleAwareConnectionFactory("Orders");
        await using var connection = factory.CreateDbConnection();
