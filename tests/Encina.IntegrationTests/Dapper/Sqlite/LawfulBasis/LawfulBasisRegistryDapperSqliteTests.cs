...
using Encina.Dapper.Sqlite.LawfulBasis;
using Encina.TestInfrastructure.Fixtures;
using FluentAssertions;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.Sqlite.LawfulBasis;

[Collection("Dapper-Sqlite")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.Sqlite")]
public sealed class LawfulBasisRegistryDapperSqliteTests : IAsyncLifetime
{
    private readonly SqliteFixture _fixture;
    private LawfulBasisRegistryDapper _store = null!;

    public LawfulBasisRegistryDapperSqliteTests(SqliteFixture fixture)
    {
        _fixture = fixture;
    }
    ...
    private static LawfulBasisRegistration CreateRegistration(
        ...
        {
            RequestType = requestType ?? typeof(LawfulBasisRegistryDapperSqliteTests),
            Basis = basis,
