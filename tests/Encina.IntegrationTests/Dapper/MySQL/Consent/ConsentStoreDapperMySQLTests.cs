...
using Encina.Dapper.MySQL.Consent;
using Encina.TestInfrastructure.Fixtures;
using LanguageExt;

namespace Encina.IntegrationTests.Dapper.MySQL.Consent;

/// <summary>
/// Integration tests for <see cref="ConsentStoreDapper"/> with MySQL.
/// Tests the Dapper implementation of the consent store using a real MySQL database via Testcontainers.
/// </summary>
[Collection("Dapper-MySQL")]
[Trait("Category", "Integration")]
[Trait("Provider", "Dapper.MySQL")]
public sealed class ConsentStoreDapperMySQLTests : IAsyncLifetime
{
    private readonly MySqlFixture _fixture;
    private ConsentStoreDapper _store = null!;

    public ConsentStoreDapperMySQLTests(MySqlFixture fixture)
    {
        _fixture = fixture;
    }
