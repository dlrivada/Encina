...
/// <summary>
/// Integration tests for read/write separation in Dapper MySQL provider.
/// Tests connection routing logic using the same database (simulated separation).
/// </summary>
/// <remarks>
/// <para>
/// Since setting up actual MySQL replication requires complex infrastructure,
...
/// </list>
/// <para>
/// In production MySQL scenarios, read replicas would use MySQL replication
...
public class ReadWriteSeparationDapperIntegrationTests : ReadWriteSeparationTestsBase<MySqlFixture>
{
    ...
    /// <inheritdoc />
    protected override string ProviderName => "Dapper.MySQL";
