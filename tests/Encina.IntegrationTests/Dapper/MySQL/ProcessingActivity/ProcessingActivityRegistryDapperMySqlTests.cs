...
public sealed class ProcessingActivityRegistryDapperMySqlTests : IAsyncLifetime
{
    private readonly MySqlFixture _fixture;
    private ProcessingActivityRegistryDapper _store = null!;

    public ProcessingActivityRegistryDapperMySqlTests(MySqlFixture fixture) => _fixture = fixture;
    ...
    private static global::Encina.Compliance.GDPR.ProcessingActivity CreateActivity(Type? requestType = null) => new()
    {
        ...
        RequestType = requestType ?? typeof(ProcessingActivityRegistryDapperMySqlTests),
