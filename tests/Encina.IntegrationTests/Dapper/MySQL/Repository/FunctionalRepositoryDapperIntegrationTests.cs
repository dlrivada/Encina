...
namespace Encina.IntegrationTests.Dapper.MySQL.Repository;
...
public class FunctionalRepositoryDapperIntegrationTests : IAsyncLifetime
{
    ...
    private static async Task CreateTestProductsSchemaAsync(MySqlConnection connection)
    {
        const string sql = """
            ...
            CREATE INDEX ix_test_products_is_active ON test_products(is_active);
            """;
    ...
    private async Task ClearDataAsync()
    {
        ...
        {
            await using var command = new MySqlCommand("DELETE FROM test_products", mysqlConnection);
            await command.ExecuteNonQueryAsync();
        }
    }
...
/// <summary>
/// Test product entity for Dapper MySQL repository integration tests.
/// </summary>
