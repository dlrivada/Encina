...
namespace SimpleMediator.Extensions.Resilience.ContractTests;
...
{
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilience_MustReturnIServiceCollection()
    {
        // Arrange
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilience_WithOptions_MustReturnIServiceCollection()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethod(
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilienceFor_MustReturnIServiceCollection()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethods()
            .FirstOrDefault(m => m.Name == "AddSimpleMediatorStandardResilienceFor" && m.IsGenericMethodDefinition);
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilience_MustBeExtensionMethod()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethod(
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilienceFor_MustBeExtensionMethod()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethods()
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilience_FirstParameterMustBeThis()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethod(
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilienceFor_MustHaveGenericConstraints()
    {
        // Arrange
        var extensionsType = typeof(ServiceCollectionExtensions);
        var method = extensionsType.GetMethods()
    ...
    [Fact]
    public void Contract_AddSimpleMediatorStandardResilience_ShouldAcceptNullConfigure()
    {
        // Arrange
        var services = new ServiceCollection();

        // Act - passing null should be handled by the parameterless overload
        var act = () => services.AddSimpleMediatorStandardResilience();
    ...
    public void Contract_ExtensionMethods_MustBeFluentlyChainable()
    {
        ...
        var result = services
            .AddSimpleMediatorStandardResilience()
            .AddSimpleMediatorStandardResilienceFor<TestRequest, TestResponse>(_ => { });
