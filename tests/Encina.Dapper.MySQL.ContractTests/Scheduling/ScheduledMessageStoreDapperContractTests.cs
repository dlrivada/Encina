...
public sealed class ScheduledMessageStoreDapperContractTests : IClassFixture<MySqlFixture>
{
    private readonly MySqlFixture _database;
    private readonly ScheduledMessageStoreDapper _store;

    public ScheduledMessageStoreDapperContractTests(MySqlFixture database)
    {
        _database = database;
