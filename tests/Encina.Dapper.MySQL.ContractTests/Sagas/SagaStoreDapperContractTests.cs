...
namespace Encina.Dapper.MySQL.Tests.Sagas;
...
public sealed class SagaStoreDapperContractTests : IClassFixture<MySqlFixture>
{
    private readonly MySqlFixture _database;
    private readonly SagaStoreDapper _store;

    public SagaStoreDapperContractTests(MySqlFixture database)
    {
        _database = database;
