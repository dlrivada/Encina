...
namespace Encina.Dapper.MySQL.ContractTests.Health;

/// <summary>
/// Contract tests for <see cref="MySqlHealthCheck"/> ensuring it follows the IEncinaHealthCheck contract.
/// </summary>
public sealed class MySqlHealthCheckContractTests : IEncinaHealthCheckContractTests
{
    protected override IEncinaHealthCheck CreateHealthCheck()
    {
        var serviceProvider = CreateMockServiceProvider();
        return new MySqlHealthCheck(serviceProvider, null);
    }
    ...
    protected override IEncinaHealthCheck CreateHealthCheckWithCustomName(string name)
    {
        ...
        return new MySqlHealthCheck(serviceProvider, options);
    }
    ...
    [Fact]
    public void DefaultName_ShouldBeEncinaMysql()
    {
        MySqlHealthCheck.DefaultName.Should().Be("encina-mysql");
    }
