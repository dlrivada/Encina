...
namespace Encina.GuardTests.Dapper.PostgreSQL.Auditing;

/// <summary>
/// Guard tests for <see cref="AuditLogStoreDapper"/> to verify null parameter handling.
/// </summary>
public class AuditLogStoreDapperGuardTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        // Act & Assert
        var act = () => new AuditLogStoreDapper(null!);
    ...
    public void Constructor_ValidConnection_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new AuditLogStoreDapper(connection));
    }
    ...
    public void Constructor_CustomTableName_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new AuditLogStoreDapper(connection, "CustomAuditLogs"));
    }
