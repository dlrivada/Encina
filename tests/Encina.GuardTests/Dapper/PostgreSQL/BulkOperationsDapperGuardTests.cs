using System.Data;
using Encina.Dapper.PostgreSQL.BulkOperations;
...
/// <summary>
/// Guard tests for <see cref="BulkOperationsDapper{TEntity, TId}"/> to verify null parameter handling.
/// </summary>
public class BulkOperationsDapperGuardTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsDapper<TestEntity, Guid>(null!, mapping);
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsDapper<TestEntity, Guid>(connection, null!);
        var ex = Should.Throw<ArgumentNullException>(act);
    ...
    public void Constructor_ValidParameters_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new BulkOperationsDapper<TestEntity, Guid>(connection, mapping));
    }
    ...
    private static BulkOperationsDapper<TestEntity, Guid> CreateSut()
    {
        var connection = Substitute.For<IDbConnection>();
        var mapping = Substitute.For<IEntityMapping<TestEntity, Guid>>();
        mapping.ColumnMappings.Returns(new Dictionary<string, string>());
        return new BulkOperationsDapper<TestEntity, Guid>(connection, mapping);
    }
