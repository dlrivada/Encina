...
namespace Encina.GuardTests.Dapper.PostgreSQL.ProcessingActivity;
...
public class ProcessingActivityRegistryDapperGuardTests
{
    ...
    {
        // Act & Assert
        Should.NotThrow(() => new ProcessingActivityRegistryDapper("Host=localhost;Database=test;"));
    }
    ...
    {
        // Arrange
        var registry = new ProcessingActivityRegistryDapper("Host=localhost;Database=test;");
