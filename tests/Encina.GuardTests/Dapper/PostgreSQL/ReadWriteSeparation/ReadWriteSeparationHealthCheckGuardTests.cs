...
namespace Encina.GuardTests.Dapper.PostgreSQL.ReadWriteSeparation;
...
public class ReadWriteSeparationHealthCheckGuardTests
{
    ...
    {
        // Assert
        ReadWriteSeparationHealthCheck.DefaultName.ShouldBe("encina-read-write-separation-dapper-postgresql");
    }
}
