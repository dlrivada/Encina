...
public sealed class EntityMappingBuilderGuardTests
{
    ...
    {
        // Arrange
        var builder = new EntityMappingBuilder<GuardTestOrderDapperOracle, Guid>();
    ...
    public void HasId_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new EntityMappingBuilder<GuardTestOrderDapperOracle, Guid>();
        System.Linq.Expressions.Expression<Func<GuardTestOrderDapperOracle, Guid>> expression = null!;
    ...
    public void MapProperty_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new EntityMappingBuilder<GuardTestOrderDapperOracle, Guid>();
        System.Linq.Expressions.Expression<Func<GuardTestOrderDapperOracle, object>> expression = null!;
...
/// </summary>
public sealed class GuardTestOrderDapperOracle
{
