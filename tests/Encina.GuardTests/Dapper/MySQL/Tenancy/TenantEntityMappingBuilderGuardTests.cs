...
public class TenantEntityMappingBuilderGuardTests
{
    ...
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderDapperMySQL, Guid>();
    ...
    public void HasId_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderDapperMySQL, Guid>();
        Expression<Func<TenantGuardTestOrderDapperMySQL, Guid>> propertySelector = null!;
    ...
    public void HasTenantId_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderDapperMySQL, Guid>();
        Expression<Func<TenantGuardTestOrderDapperMySQL, string>> propertySelector = null!;
    ...
    public void MapProperty_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderDapperMySQL, Guid>();
        Expression<Func<TenantGuardTestOrderDapperMySQL, decimal>> propertySelector = null!;
...
/// </summary>
public class TenantGuardTestOrderDapperMySQL
{
