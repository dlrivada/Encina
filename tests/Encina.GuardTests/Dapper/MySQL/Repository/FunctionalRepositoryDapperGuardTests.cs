...
public sealed class FunctionalRepositoryDapperGuardTests
{
    ...
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        var ex = Should.Throw<ArgumentNullException>(() =>
            new FunctionalRepositoryDapper<GuardTestEntityDapperMySQL, Guid>(connection, mapping));
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        IEntityMapping<GuardTestEntityDapperMySQL, Guid> mapping = null!;
    ...
    private static IEntityMapping<GuardTestEntityDapperMySQL, Guid> CreateTestMapping()
    {
        return new EntityMappingBuilder<GuardTestEntityDapperMySQL, Guid>()
...
/// </summary>
public sealed class GuardTestEntityDapperMySQL
{
