...
/// <summary>
/// Guard tests for <see cref="QueryMetricsPipelineBehavior{TQuery, TResponse}"/>
/// to verify constructor null guards and Handle error paths.
/// </summary>
public class QueryMetricsPipelineBehaviorGuardTests
{
    /// <summary>
    ...
    {
        var act = () => new QueryMetricsPipelineBehavior<TestQuery, TestResponse>(
            null!,
    ...
    private static QueryMetricsPipelineBehavior<TestQuery, TestResponse> CreateBehavior(
        IEncinaMetrics? metrics = null)
    {
        return new QueryMetricsPipelineBehavior<TestQuery, TestResponse>(
