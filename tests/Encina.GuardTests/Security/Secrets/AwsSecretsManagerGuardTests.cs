...
/// <summary>
/// Guard clause tests for Encina.Security.Secrets.AwsSecretsManager types.
/// Verifies that null and invalid arguments are properly rejected.
/// </summary>
public class AwsSecretsManagerGuardTests
{
    #region AwsSecretsManagerProvider Constructor Guards

    [Fact]
    public void Constructor_NullClient_ThrowsArgumentNullException()
    {
        var logger = Substitute.For<ILogger<AwsSecretsManagerProvider>>();
