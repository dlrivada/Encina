...
public sealed class TenantAwareFunctionalRepositoryADOGuardTests
{
    ...
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        var ex = Should.Throw<ArgumentNullException>(() =>
            new TenantAwareFunctionalRepositoryADO<TenantGuardTestEntityOracle, Guid>(
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        ITenantEntityMapping<TenantGuardTestEntityOracle, Guid> mapping = null!;
        var tenantProvider = Substitute.For<ITenantProvider>();
        var options = new ADOTenancyOptions();
    ...
    private static ITenantEntityMapping<TenantGuardTestEntityOracle, Guid> CreateTestMapping()
    {
        return new TenantEntityMappingBuilder<TenantGuardTestEntityOracle, Guid>()
...
/// </summary>
public sealed class TenantGuardTestEntityOracle : ITenantEntity
{
