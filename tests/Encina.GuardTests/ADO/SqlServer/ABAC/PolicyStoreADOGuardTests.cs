...
namespace Encina.GuardTests.ADO.SqlServer.ABAC;

/// <summary>
/// Guard tests for <see cref="PolicyStoreADO"/> to verify null and invalid parameter handling.
/// </summary>
public class PolicyStoreADOGuardTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new PolicyStoreADO(null!, serializer);
    ...
    public void Constructor_NullSerializer_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new PolicyStoreADO(connection, null!);
        var ex = Should.Throw<ArgumentNullException>(act);
    ...
    public void Constructor_ValidParameters_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new PolicyStoreADO(connection, serializer));
    }
    ...
    private static PolicyStoreADO CreateStore()
    {
        var connection = Substitute.For<IDbConnection>();
        var serializer = Substitute.For<IPolicySerializer>();
        return new PolicyStoreADO(connection, serializer);
    }
}
