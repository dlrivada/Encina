...
public class ServiceCollectionExtensionsGuardsTests
{
    ...
    // ----- AddEncinaBulkOperations guards -----

    /// <summary>
    /// Verifies that AddEncinaBulkOperations throws ArgumentNullException when services is null.
    /// </summary>
    [Fact]
    public void AddEncinaBulkOperations_NullServices_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => services.AddEncinaBulkOperations<SvcExtTestEntity, Guid>();
        Should.Throw<ArgumentNullException>(act).ParamName.ShouldBe(nameof(services));
    }

    // ----- AddEncinaProcessingActivityADOSqlServer guards -----

    /// <summary>
    /// Verifies that AddEncinaProcessingActivityADOSqlServer throws ArgumentNullException when services is null.
    /// </summary>
    [Fact]
    public void AddEncinaProcessingActivityADOSqlServer_NullServices_ThrowsArgumentNullException()
    {
        // Arrange
        IServiceCollection services = null!;
        var connectionString = "Server=localhost;Database=test;";
        ...
        // Act & Assert
        var act = () => services.AddEncinaProcessingActivityADOSqlServer(connectionString);
        Should.Throw<ArgumentNullException>(act).ParamName.ShouldBe(nameof(services));
    }

    /// <summary>
    /// Verifies that AddEncinaProcessingActivityADOSqlServer throws ArgumentException when connectionString is null.
    /// </summary>
    [Fact]
    public void AddEncinaProcessingActivityADOSqlServer_NullConnectionString_ThrowsArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        string connectionString = null!;
    ...
    /// <summary>
    /// Verifies that AddEncinaProcessingActivityADOSqlServer throws ArgumentException when connectionString is empty.
    /// </summary>
    [Fact]
    public void AddEncinaProcessingActivityADOSqlServer_EmptyConnectionString_ThrowsArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    /// <summary>
    /// Verifies that AddEncinaProcessingActivityADOSqlServer throws ArgumentException when connectionString is whitespace.
    /// </summary>
    [Fact]
    public void AddEncinaProcessingActivityADOSqlServer_WhitespaceConnectionString_ThrowsArgumentException()
    {
        // Arrange
        var services = new ServiceCollection();
        var connectionString = "   ";
