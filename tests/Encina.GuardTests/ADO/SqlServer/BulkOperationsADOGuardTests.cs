...
/// <summary>
/// Guard tests for <see cref="BulkOperationsADO{TEntity, TId}"/> to verify null parameter handling.
/// </summary>
public class BulkOperationsADOGuardTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsADO<TestEntity, Guid>(null!, mapping);
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsADO<TestEntity, Guid>(connection, null!);
        var ex = Should.Throw<ArgumentNullException>(act);
    ...
    public void Constructor_ValidParameters_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new BulkOperationsADO<TestEntity, Guid>(connection, mapping));
    }
    ...
    private static BulkOperationsADO<TestEntity, Guid> CreateSut()
    {
        var connection = Substitute.For<IDbConnection>();
        var mapping = Substitute.For<IEntityMapping<TestEntity, Guid>>();
        mapping.ColumnMappings.Returns(new Dictionary<string, string>());
        return new BulkOperationsADO<TestEntity, Guid>(connection, mapping);
    }
