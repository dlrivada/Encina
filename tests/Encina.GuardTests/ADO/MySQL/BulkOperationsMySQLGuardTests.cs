...
/// <summary>
/// Guard tests for <see cref="BulkOperationsMySQL{TEntity, TId}"/> to verify null parameter handling.
/// </summary>
public class BulkOperationsMySQLGuardTests
{
    ...
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsMySQL<TestEntity, Guid>(null!, mapping);
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        var act = () => new BulkOperationsMySQL<TestEntity, Guid>(connection, null!);
        var ex = Should.Throw<ArgumentNullException>(act);
    ...
    public void Constructor_ValidParameters_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new BulkOperationsMySQL<TestEntity, Guid>(connection, mapping));
    }
    ...
    private static BulkOperationsMySQL<TestEntity, Guid> CreateSut()
    {
        var connection = Substitute.For<IDbConnection>();
        var mapping = Substitute.For<IEntityMapping<TestEntity, Guid>>();
        mapping.ColumnMappings.Returns(new Dictionary<string, string>());
        return new BulkOperationsMySQL<TestEntity, Guid>(connection, mapping);
    }
