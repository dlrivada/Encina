...
namespace Encina.GuardTests.ADO.PostgreSQL.ProcessingActivity;
...
public class ProcessingActivityRegistryADOGuardTests
{
    ...
    {
        // Act & Assert
        Should.NotThrow(() => new ProcessingActivityRegistryADO("Host=localhost;Database=test;"));
    }
    ...
    {
        // Arrange
        var registry = new ProcessingActivityRegistryADO("Host=localhost;Database=test;");
