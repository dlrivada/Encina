...
public sealed class TenantEntityMappingBuilderGuardTests
{
    ...
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderPostgreSQL, Guid>();
    ...
    public void HasId_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderPostgreSQL, Guid>();
        System.Linq.Expressions.Expression<Func<TenantGuardTestOrderPostgreSQL, Guid>> expression = null!;
    ...
    public void HasTenantId_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderPostgreSQL, Guid>();
        System.Linq.Expressions.Expression<Func<TenantGuardTestOrderPostgreSQL, string>> expression = null!;
    ...
    public void MapProperty_NullExpression_ThrowsArgumentNullException()
    {
        // Arrange
        var builder = new TenantEntityMappingBuilder<TenantGuardTestOrderPostgreSQL, Guid>();
        System.Linq.Expressions.Expression<Func<TenantGuardTestOrderPostgreSQL, object>> expression = null!;
...
/// </summary>
public sealed class TenantGuardTestOrderPostgreSQL : ITenantEntity
{
