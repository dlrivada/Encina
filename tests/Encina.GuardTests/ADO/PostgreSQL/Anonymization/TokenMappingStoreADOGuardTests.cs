using System.Data;
using Encina.ADO.PostgreSQL.Anonymization;
using Encina.Compliance.Anonymization.Model;
using NSubstitute;
using Shouldly;

namespace Encina.GuardTests.ADO.PostgreSQL.Anonymization;

/// <summary>
/// Guard tests for <see cref="TokenMappingStoreADO"/> to verify null and invalid parameter handling.
/// </summary>
public class TokenMappingStoreADOGuardTests
{
    [Fact]
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        // Act & Assert
        var act = () => new TokenMappingStoreADO(null!);
    ...
    public void Constructor_ValidConnection_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new TokenMappingStoreADO(connection));
    }
    ...
    public void Constructor_CustomTableName_DoesNotThrow()
    {
        ...
        // Act & Assert
        Should.NotThrow(() => new TokenMappingStoreADO(connection, "CustomTokenMappings"));
    }
    ...
    public async Task StoreAsync_NullMapping_ThrowsArgumentNullException()
    {
        // Arrange
        var connection = Substitute.For<IDbConnection>();
        var store = new TokenMappingStoreADO(connection);
