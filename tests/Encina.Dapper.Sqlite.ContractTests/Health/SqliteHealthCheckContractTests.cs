...
namespace Encina.Dapper.Sqlite.ContractTests.Health;

/// <summary>
/// Contract tests for <see cref="SqliteHealthCheck"/> ensuring it follows the IEncinaHealthCheck contract.
/// </summary>
public sealed class SqliteHealthCheckContractTests : IEncinaHealthCheckContractTests
{
    ...
    [Fact]
    public void DefaultName_ShouldBeEncinaSqlite()
    {
        SqliteHealthCheck.DefaultName.Should().Be("encina-sqlite");
    }
