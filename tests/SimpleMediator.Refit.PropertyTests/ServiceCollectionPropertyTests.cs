...
namespace SimpleMediator.Refit.PropertyTests;
...
{
    [Property]
    public FsCheck.Property Property_AddSimpleMediatorRefitClient_AlwaysRegistersClient()
    {
    ...
    public FsCheck.Property Property_RefitSettings_AlwaysAccepted()
    {
        return Prop.ForAll<bool>(caseInsensitive =>
        {
            ...
            // Act
            services.AddSimpleMediatorRefitClient<ITestApi>(settings);
            var serviceProvider = services.BuildServiceProvider();
            var client = serviceProvider.GetService<ITestApi>();
    ...
    public FsCheck.Property Property_SettingsProvider_AlwaysInvoked()
    {
        return Prop.ForAll<bool>(caseInsensitive =>
        {
            ...
            // Act
            services.AddSimpleMediatorRefitClient<ITestApi>(sp =>
            {
                invoked = true;
