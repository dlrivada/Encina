...
namespace Encina.Dapper.MySQL.PropertyTests.Health;

/// <summary>
/// Property-based tests for <see cref="MySqlHealthCheck"/> invariants.
/// </summary>
public sealed class MySqlHealthCheckPropertyTests
{
    [Fact]
    public void DefaultName_IsAlwaysEncinaMysql()
    {
        Assert.Equal("encina-mysql", MySqlHealthCheck.DefaultName);
    }
