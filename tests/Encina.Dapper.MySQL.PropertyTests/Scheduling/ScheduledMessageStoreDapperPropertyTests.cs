...
namespace Encina.Dapper.MySQL.Tests.Scheduling;
...
public sealed class ScheduledMessageStoreDapperPropertyTests : IClassFixture<MySqlFixture>
{
    private readonly MySqlFixture _database;

    public ScheduledMessageStoreDapperPropertyTests(MySqlFixture database)
    {
        _database = database;
