...
namespace Encina.ADO.Sqlite.GuardTests;
...
public class OutboxPostProcessorGuardsTests
{
    ...
    public async Task Process_NullRequest_ThrowsArgumentNullException()
    {
        ...
        var postProcessor = new OutboxPostProcessor<TestRequest, string>(outboxStore, logger);

        TestRequest request = null!;
        var context = Substitute.For<IRequestContext>();
        Either<MediatorError, string> result = "test";
