...
public sealed class OutboxStoreADOLoadTests : IClassFixture<PostgreSqlFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly PostgreSqlFixture _fixture;
    private readonly OutboxStoreADO _store;

    public OutboxStoreADOLoadTests(PostgreSqlFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
