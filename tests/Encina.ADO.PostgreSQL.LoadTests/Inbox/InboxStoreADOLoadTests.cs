...
/// <summary>
/// Load tests for <see cref="InboxStoreADO"/>.
/// Verifies behavior under concurrency, volume, and stress conditions.
/// </summary>
[Trait("Category", "Load")]
public sealed class InboxStoreADOLoadTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _database;
    private readonly InboxStoreADO _store;

    public InboxStoreADOLoadTests(PostgreSqlFixture database)
    {
        _database = database;
