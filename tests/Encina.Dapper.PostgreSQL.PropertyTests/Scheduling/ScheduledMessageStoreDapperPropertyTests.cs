...
public sealed class ScheduledMessageStoreDapperPropertyTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _database;

    public ScheduledMessageStoreDapperPropertyTests(PostgreSqlFixture database)
    {
        _database = database;
