...
/// <summary>
/// Base class for lock provider factories providing common initialization and disposal logic.
/// </summary>
public abstract class LockProviderFactoryBase : ILockProviderFactory
{
    ...
    /// <inheritdoc/>
    public abstract LockProviderCategory Category { get; }

    /// <inheritdoc/>
    public LockProviderOptions Options { get; }

    /// <inheritdoc/>
    public virtual bool IsAvailable => _isInitialized && !_isDisposed;

    /// <summary>
    /// Initializes a new instance of the <see cref="LockProviderFactoryBase"/> class.
    /// </summary>
    /// <param name="configureOptions">Optional delegate to configure options.</param>
    protected LockProviderFactoryBase(Action<LockProviderOptions>? configureOptions = null)
    {
        Options = new LockProviderOptions();
    ...
    /// <inheritdoc/>
    public abstract IDistributedLockProvider CreateLockProvider();
