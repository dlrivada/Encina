...
namespace Encina.Dapper.SqlServer.Tests.Scheduling;
...
public sealed class ScheduledMessageStoreDapperPropertyTests : IClassFixture<SqlServerFixture>
{
    private readonly SqlServerFixture _database;

    public ScheduledMessageStoreDapperPropertyTests(SqlServerFixture database)
    {
        _database = database;
