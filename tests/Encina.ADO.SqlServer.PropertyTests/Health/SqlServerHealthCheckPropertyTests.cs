...
namespace Encina.ADO.SqlServer.PropertyTests.Health;

/// <summary>
/// Property-based tests for <see cref="SqlServerHealthCheck"/> invariants (ADO.NET).
/// </summary>
public sealed class SqlServerHealthCheckPropertyTests
{
    [Fact]
    public void DefaultName_IsAlwaysEncinaAdoSqlserver()
    {
        Assert.Equal("encina-ado-sqlserver", SqlServerHealthCheck.DefaultName);
    }
