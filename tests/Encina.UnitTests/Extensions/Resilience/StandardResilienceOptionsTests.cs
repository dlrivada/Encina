...
namespace Encina.UnitTests.Extensions.Resilience;
...
public class StandardResilienceOptionsTests
{
    ...
    public void RateLimiter_ShouldBeSettable()
    {
        // Arrange
        var options = new StandardResilienceOptions();
        var newRateLimiter = new global::Polly.RateLimiting.RateLimiterStrategyOptions();
    ...
    public void TotalRequestTimeout_ShouldBeSettable()
    {
        // Arrange
        var options = new StandardResilienceOptions();
        var newTimeout = new global::Polly.Timeout.TimeoutStrategyOptions { Timeout = TimeSpan.FromSeconds(60) };
    ...
    public void Retry_ShouldBeSettable()
    {
        // Arrange
        var options = new StandardResilienceOptions();
        var newRetry = new global::Polly.Retry.RetryStrategyOptions
        {
            MaxRetryAttempts = 5,
    ...
    public void CircuitBreaker_ShouldBeSettable()
    {
        // Arrange
        var options = new StandardResilienceOptions();
        var newCircuitBreaker = new global::Polly.CircuitBreaker.CircuitBreakerStrategyOptions
        {
            FailureRatio = 0.2
        };
    ...
    public void AttemptTimeout_ShouldBeSettable()
    {
        // Arrange
        var options = new StandardResilienceOptions();
        var newTimeout = new global::Polly.Timeout.TimeoutStrategyOptions { Timeout = TimeSpan.FromSeconds(15) };
