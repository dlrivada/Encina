...
{
    private const string TestConnectionString = "Server=localhost;Database=test;User Id=test;Password=test;TrustServerCertificate=true";
    ...
    public void AddEncinaADO_WithConnectionString_NullServices_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services!.AddEncinaADO(TestConnectionString, _ => { }));
    }
    ...
    public void AddEncinaADO_WithConnectionString_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddEncinaADO(TestConnectionString, null!));
    }
    ...
    public void AddEncinaADO_WithConnectionString_ValidParameters_ReturnsServiceCollection()
    {
        ...
        // Act
        var result = services.AddEncinaADO(TestConnectionString, _ => { });
