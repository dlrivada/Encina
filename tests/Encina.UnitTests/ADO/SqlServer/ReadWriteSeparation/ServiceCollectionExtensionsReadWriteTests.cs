...
namespace Encina.UnitTests.ADO.SqlServer.ReadWriteSeparation;
...
public sealed class ServiceCollectionExtensionsReadWriteTests
{
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersOptions()
    {
        // Arrange
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersReplicaSelector()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersConnectionSelector()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersConnectionFactory()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersPipelineBehavior()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddLogging();
    ...
    [Fact]
    public void AddEncinaADO_WithReadWriteSeparation_RegistersHealthCheck()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithoutReadWriteSeparation_DoesNotRegisterComponents()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithRandomStrategy_RegistersRandomSelector()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithLeastConnectionsStrategy_RegistersLeastConnectionsSelector()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithMultipleReplicas_RegistersAllReplicas()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    [Fact]
    public void AddEncinaADO_WithNoReplicas_RegistersConnectionSelectorWithFallback()
    {
        // Arrange
        var services = new ServiceCollection();
