...
/// <summary>
/// Unit tests for <see cref="TenantEntityMappingBuilder{TEntity, TId}"/> in ADO.NET SQLite.
/// </summary>
[Trait("Category", "Unit")]
public sealed class TenantEntityMappingBuilderTests
{
    ...
    {
        // Arrange & Act
        var mapping = new TenantEntityMappingBuilder<SqliteTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
...
/// <summary>
/// Test entity implementing <see cref="ITenantEntity"/> for ADO.NET SQLite tenancy tests.
/// </summary>
public sealed class SqliteTenantTestOrder : ITenantEntity
{
