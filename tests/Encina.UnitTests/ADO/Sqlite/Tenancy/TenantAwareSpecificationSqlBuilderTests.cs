...
public sealed class TenantAwareSpecificationSqlBuilderTests
{
    ...
    private readonly ITenantEntityMapping<SqliteTenantTestOrder, object> _tenantMapping;
    private readonly ITenantEntityMapping<SqliteTenantTestOrder, object> _nonTenantMapping;
    ...
    public TenantAwareSpecificationSqlBuilderTests()
    {
        ...
        var tenantMappingBuilder = new TenantEntityMappingBuilder<SqliteTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
        ...
        _tenantMapping = new SqliteGenericTenantMappingAdapter<SqliteTenantTestOrder, Guid>(tenantMapping);

        // Create non-tenant entity mapping
        var nonTenantMappingBuilder = new TenantEntityMappingBuilder<SqliteTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
            .MapProperty(o => o.CustomerId)
            .MapProperty(o => o.Total);
        ...
        _nonTenantMapping = new SqliteGenericTenantMappingAdapter<SqliteTenantTestOrder, Guid>(nonTenantMapping);
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(null!, _tenantProvider, _options));
    }
    ...
    public void Constructor_NullTenantProvider_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(_tenantMapping, null!, _options));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(_tenantMapping, _tenantProvider, null!));
    }
    ...
    public void BuildWhereClause_WithTenantContext_IncludesTenantFilter()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
    ...
    public void BuildWhereClause_WithoutTenantContext_ThrowsException_WhenConfigured()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(_tenantMapping, _tenantProvider, options);
        var spec = new SqliteActiveOrdersSpec();
    ...
    public void BuildWhereClause_NonTenantEntity_NoFilter()
    {
        // Arrange
        _tenantProvider.GetCurrentTenantId().Returns("tenant-123");
        var builder = new TenantAwareSpecificationSqlBuilder<SqliteTenantTestOrder>(_nonTenantMapping, _tenantProvider, _options);
        var spec = new SqliteActiveOrdersSpec();
    ...
    private static IDbCommand CreateMockCommand()
    {
        ...
        var parameters = new SqliteTestParameterCollection();
...
/// </summary>
internal sealed class SqliteGenericTenantMappingAdapter<TEntity, TId> : ITenantEntityMapping<TEntity, object>
    where TEntity : class
    where TId : notnull
{
    private readonly ITenantEntityMapping<TEntity, TId> _innerMapping;

    public SqliteGenericTenantMappingAdapter(ITenantEntityMapping<TEntity, TId> innerMapping)
    {
...
/// <summary>
/// Simple test parameter collection for SQLite tests.
/// </summary>
internal sealed class SqliteTestParameterCollection : List<object>, IDataParameterCollection
{
...
/// <summary>
/// Specification that filters for active SQLite tenant orders.
/// </summary>
internal sealed class SqliteActiveOrdersSpec : Specification<SqliteTenantTestOrder>
{
    public override Expression<Func<SqliteTenantTestOrder, bool>> ToExpression()
        => o => o.IsActive;
}
...
/// </summary>
internal sealed class SqliteMinTotalSpec : Specification<SqliteTenantTestOrder>
{
...
// SqliteTenantTestOrder is defined in TenantEntityMappingBuilderTests.cs
