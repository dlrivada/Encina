...
namespace Encina.UnitTests.ADO.Sqlite.Auditing;

/// <summary>
/// Unit tests for <see cref="AuditLogStoreADO"/>.
/// </summary>
public sealed class AuditLogStoreADOTests
{
    ...
    public void Constructor_WithCustomTableName_CreatesInstance()
    {
        ...
        // Act
        var store = new AuditLogStoreADO(connection, "CustomAuditLogs");
    ...
    public void Constructor_InvalidTableName_ThrowsArgumentException(string? tableName)
    {
        ...
        Should.Throw<ArgumentException>(() =>
            new AuditLogStoreADO(connection, tableName!));
    }
