...
/// <summary>
/// Unit tests for <see cref="FunctionalRepositoryADO{TEntity, TId}"/> for Oracle.
...
public class FunctionalRepositoryADOTests : IDisposable
{
    ...
    private readonly IEntityMapping<TestEntityOracleADO, Guid> _mapping;
    private readonly FunctionalRepositoryADO<TestEntityOracleADO, Guid> _repository;
    ...
    public FunctionalRepositoryADOTests()
    {
        ...
        _mapping = new EntityMappingBuilder<TestEntityOracleADO, Guid>()
        ...
        _repository = new FunctionalRepositoryADO<TestEntityOracleADO, Guid>(_mockConnection, _mapping);
    }
    ...
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new FunctionalRepositoryADO<TestEntityOracleADO, Guid>(null!, _mapping));
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new FunctionalRepositoryADO<TestEntityOracleADO, Guid>(connection, null!));
    }
    ...
    {
        // Arrange
        var spec = new ActiveEntityOracleADOSpec();
    ...
    {
        // Arrange
        _mockCommand.ExecuteScalar().Returns(5m); // Oracle returns NUMBER as decimal
    ...
    public async Task CountAsync_WithSpecification_ReturnsFilteredCount()
    {
        // Arrange
        var spec = new ActiveEntityOracleADOSpec();
        _mockCommand.ExecuteScalar().Returns(3m); // Oracle returns NUMBER as decimal
    ...
    {
        // Arrange
        _mockCommand.ExecuteScalar().Returns(1m); // Oracle returns NUMBER as decimal
    ...
    {
        // Arrange
        _mockCommand.ExecuteScalar().Returns(0m); // Oracle returns NUMBER as decimal
    ...
    public async Task AddAsync_DuplicateKey_ReturnsLeftWithAlreadyExistsError()
    {
        ...
        _mockCommand.ExecuteNonQuery().Throws(new InvalidOperationException("ORA-00001: unique constraint violated"));
    ...
    public async Task DeleteAsync_ByEntity_NullEntity_ThrowsArgumentNullException()
    {
        // Act & Assert
        await Should.ThrowAsync<ArgumentNullException>(async () =>
            await _repository.DeleteAsync((TestEntityOracleADO)null!));
    }
    ...
    private static TestEntityOracleADO CreateTestEntity(
        string name = "Test Entity",
        bool isActive = true,
        decimal amount = 100m)
    {
        return new TestEntityOracleADO
        {
            Id = Guid.NewGuid(),
            Name = name,
            Amount = amount,
...
/// <summary>
/// Test entity for ADO.NET Oracle repository unit tests.
/// </summary>
public class TestEntityOracleADO
{
...
/// <summary>
/// Specification for active entities (Oracle ADO tests).
/// </summary>
public class ActiveEntityOracleADOSpec : Specification<TestEntityOracleADO>
{
    public override Expression<Func<TestEntityOracleADO, bool>> ToExpression()
        => e => e.IsActive;
}
...
/// </summary>
public class UnsupportedOracleSpec : Specification<TestEntityOracleADO>
{
...
/// <summary>
/// Specification for minimum amount (Oracle ADO tests).
/// </summary>
public class MinAmountOracleADOSpec : Specification<TestEntityOracleADO>
{
    private readonly decimal _minAmount;

    public MinAmountOracleADOSpec(decimal minAmount) => _minAmount = minAmount;
