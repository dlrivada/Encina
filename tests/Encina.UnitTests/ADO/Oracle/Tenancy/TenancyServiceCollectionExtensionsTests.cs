...
{
    [Fact]
    public void AddEncinaADOOracleWithTenancy_RegistersRequiredServices()
    {
        // Arrange
        ...
        // Act
        services.AddEncinaADOOracleWithTenancy(config =>
        {
    ...
    [Fact]
    public void AddEncinaADOOracleWithTenancy_WithCustomOptions_AppliesConfiguration()
    {
        // Arrange
        var services = new ServiceCollection();
        ...
        // Act
        services.AddEncinaADOOracleWithTenancy(
            config => { },
            tenancy =>
            {
    ...
    [Fact]
    public void AddEncinaADOOracleWithTenancy_RegistersTenantConnectionFactory()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    public void AddTenantAwareRepository_RegistersRepositoryWithCorrectMapping()
    {
        ...
        // Act
        services.AddTenantAwareRepository<OracleTenantTestOrder, Guid>(mapping =>
        ...
        var entityMapping = provider.GetService<ITenantEntityMapping<OracleTenantTestOrder, Guid>>();
        ...
        var repository = provider.GetService<IFunctionalRepository<OracleTenantTestOrder, Guid>>();
        repository.ShouldNotBeNull();
        repository.ShouldBeOfType<TenantAwareFunctionalRepositoryADO<OracleTenantTestOrder, Guid>>();
    }
    ...
    public void AddTenantAwareRepository_RegistersReadRepositoryInterface()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var readRepository = provider.GetService<IFunctionalReadRepository<OracleTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareReadRepository_RegistersOnlyReadRepository()
    {
        ...
        // Act
        services.AddTenantAwareReadRepository<OracleTenantTestOrder, Guid>(mapping =>
        ...
        var fullRepository = provider.GetService<IFunctionalRepository<OracleTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_WithNonTenantEntity_CreatesNonTenantAwareMapping()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var entityMapping = provider.GetRequiredService<ITenantEntityMapping<OracleTenantTestOrder, Guid>>();
        entityMapping.IsTenantEntity.ShouldBeFalse();
    }

    [Fact]
    public void AddEncinaADOOracleWithTenancy_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddEncinaADOOracleWithTenancy(config => { }));
    }

    [Fact]
    public void AddEncinaADOOracleWithTenancy_NullConfigure_ThrowsArgumentNullException()
    {
        // Arrange
        var services = new ServiceCollection();
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddEncinaADOOracleWithTenancy(null!));
    }
    ...
    public void AddTenantAwareRepository_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddTenantAwareRepository<OracleTenantTestOrder, Guid>(
    ...
    public void AddTenantAwareRepository_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddTenantAwareRepository<OracleTenantTestOrder, Guid>(null!));
    }
}
