...
public sealed class TenantEntityMappingBuilderTests
{
    ...
    {
        var mapping = new TenantEntityMappingBuilder<OracleTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
    ...
    {
        var builder = new TenantEntityMappingBuilder<OracleTenantTestOrder, Guid>()
            .HasId(o => o.Id)
            .HasTenantId(o => o.TenantId);
    ...
    public void GetTenantId_ReturnsCorrectTenantIdValue()
    {
        ...
        var order = new OracleTenantTestOrder { Id = Guid.NewGuid(), TenantId = "tenant-123" };
    ...
    public void SetTenantId_SetsCorrectTenantIdValue()
    {
        ...
        var order = new OracleTenantTestOrder { Id = Guid.NewGuid() };
...
/// <summary>
/// Test entity implementing <see cref="ITenantEntity"/> for Oracle ADO.NET tenancy tests.
/// </summary>
public sealed class OracleTenantTestOrder : ITenantEntity
{
