...
public sealed class TenantConnectionFactoryTests
{
    ...
    public TenantConnectionFactoryTests()
    {
        ...
        {
            DefaultConnectionString = "Host=localhost;Database=DefaultDb;Username=test;Password=test"
        });
    }
    ...
    public async Task GetConnectionStringAsync_NoTenantContext_ReturnsDefaultConnectionString()
    {
        ...
        // Assert
        connectionString.ShouldBe("Host=localhost;Database=DefaultDb;Username=test;Password=test");
    }
    ...
    public async Task GetConnectionStringAsync_DatabasePerTenant_ReturnsTenantConnectionString()
    {
        ...
        _tenantStore.GetTenantAsync("tenant-2", Arg.Any<CancellationToken>())
            .Returns(new TenantInfo(
                ...
                ConnectionString: "Host=localhost;Database=Tenant2Db;Username=test;Password=test"));
        ...
        // Assert
        connectionString.ShouldBe("Host=localhost;Database=Tenant2Db;Username=test;Password=test");
    }
