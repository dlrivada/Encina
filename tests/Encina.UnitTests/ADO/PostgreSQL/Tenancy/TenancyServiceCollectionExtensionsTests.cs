...
{
    [Fact]
    public void AddEncinaADOPostgreSQLWithTenancy_RegistersRequiredServices()
    {
        // Arrange
        ...
        {
            DefaultConnectionString = "Host=localhost;Database=test;Username=test;Password=test"
        }));
    ...
    [Fact]
    public void AddEncinaADOPostgreSQLWithTenancy_WithCustomOptions_AppliesConfiguration()
    {
        // Arrange
        var services = new ServiceCollection();
        ...
        // Act
        services.AddEncinaADOPostgreSQLWithTenancy(
            config => { },
            tenancy =>
            {
    ...
    [Fact]
    public void AddEncinaADOPostgreSQLWithTenancy_RegistersTenantConnectionFactory()
    {
        // Arrange
        var services = new ServiceCollection();
    ...
    public void AddTenantAwareRepository_RegistersRepositoryWithCorrectMapping()
    {
        ...
        // Act
        services.AddTenantAwareRepository<PostgreSQLTenantTestOrder, Guid>(mapping =>
        ...
        var entityMapping = provider.GetService<ITenantEntityMapping<PostgreSQLTenantTestOrder, Guid>>();
        ...
        var repository = provider.GetService<IFunctionalRepository<PostgreSQLTenantTestOrder, Guid>>();
        repository.ShouldNotBeNull();
        repository.ShouldBeOfType<TenantAwareFunctionalRepositoryADO<PostgreSQLTenantTestOrder, Guid>>();
    }
    ...
    public void AddTenantAwareRepository_RegistersReadRepositoryInterface()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var readRepository = provider.GetService<IFunctionalReadRepository<PostgreSQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareReadRepository_RegistersOnlyReadRepository()
    {
        ...
        // Act
        services.AddTenantAwareReadRepository<PostgreSQLTenantTestOrder, Guid>(mapping =>
        ...
        var fullRepository = provider.GetService<IFunctionalRepository<PostgreSQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_WithNonTenantEntity_CreatesNonTenantAwareMapping()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var entityMapping = provider.GetRequiredService<ITenantEntityMapping<PostgreSQLTenantTestOrder, Guid>>();
        entityMapping.IsTenantEntity.ShouldBeFalse();
    }

    [Fact]
    public void AddEncinaADOPostgreSQLWithTenancy_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddEncinaADOPostgreSQLWithTenancy(config => { }));
    }

    [Fact]
    public void AddEncinaADOPostgreSQLWithTenancy_NullConfigure_ThrowsArgumentNullException()
    {
        // Arrange
        var services = new ServiceCollection();
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddEncinaADOPostgreSQLWithTenancy(null!));
    }
    ...
    public void AddTenantAwareRepository_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddTenantAwareRepository<PostgreSQLTenantTestOrder, Guid>(
    ...
    public void AddTenantAwareRepository_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddTenantAwareRepository<PostgreSQLTenantTestOrder, Guid>(null!));
    }
}
