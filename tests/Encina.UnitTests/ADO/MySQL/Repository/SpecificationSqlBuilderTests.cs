...
namespace Encina.UnitTests.ADO.MySQL.Repository;

/// <summary>
/// Unit tests for <see cref="SpecificationSqlBuilder{TEntity}"/> in ADO.NET MySQL.
/// Tests MySQL-specific SQL syntax with backtick identifier quoting.
/// </summary>
[Trait("Category", "Unit")]
public class SpecificationSqlBuilderTests
{
    ...
    public void BuildWhereClause_GreaterThan_GeneratesCorrectSql()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new GreaterThanTotalMySqlSpec(500m);
    ...
    public void BuildWhereClause_LessThan_GeneratesCorrectSql()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new LessThanTotalMySqlSpec(500m);
    ...
    public void BuildWhereClause_BooleanProperty_GeneratesCorrectSql()
    {
        ...
        // Assert - MySQL uses TINYINT(1) so boolean = 1
    ...
    [Fact]
    public void BuildSelectStatement_IncludesAllMappedColumns_WithBackticks()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
    ...
    public void BuildWhereClause_MultipleParameters_AddsAllToCommand()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new MinTotalMySqlSpec(100m).And(new MaxTotalMySqlSpec(1000m));
        var command = CreateMockCommand();
    ...
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() => new SpecificationSqlBuilder<TestOrderMySQL>(null!));
    }
    ...
    public void BuildWhereClause_BooleanTrueConstant_Generates1Equals1()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new TrueConstantMySqlSpec();
    ...
    public void BuildWhereClause_BooleanFalseConstant_Generates1Equals0()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new FalseConstantMySqlSpec();
    ...
    public void BuildWhereClause_StringEquals_GeneratesEqualityClause()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new DescriptionEqualsMySqlSpec("Test");
    ...
    public void BuildWhereClause_StringEqualsNull_GeneratesIsNull()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new DescriptionEqualsNullMySqlSpec();
    ...
    public void BuildWhereClause_UnsupportedStringMethod_Throws()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new TrimStringMethodMySqlSpec();
    ...
    public void BuildWhereClause_UnsupportedBinaryOperator_ThrowsNotSupportedException()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new UnsupportedBinaryOperatorMySqlSpec();
    ...
    public void BuildWhereClause_NegateUnaryOperator_HandledAsConvert()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new NegateOperatorMySqlSpec();
    ...
    public void BuildWhereClause_UnsupportedExpression_ThrowsNotSupportedException()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new UnsupportedExpressionMySqlSpec();
    ...
    public void BuildWhereClause_UnsupportedMethodCall_ThrowsNotSupportedException()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new UnsupportedMethodCallMySqlSpec();
    ...
    public void BuildWhereClause_ConvertExpression_HandlesCorrectly()
    {
        // Arrange
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(_columnMappings);
        var spec = new NullableTotalMySqlSpec(100m);
    ...
    public void BuildWhereClause_PropertyNotInMappings_UsesPropertyNameDirectly()
    {
        ...
        var builder = new SpecificationSqlBuilder<TestOrderMySQL>(limitedMappings);
        var spec = new ActiveOrdersMySqlSpec();
    ...
    private static IDbCommand CreateMockCommand()
    {
        ...
        var parameters = new TestParameterCollectionMySQL();

        command.Parameters.Returns(parameters);
        command.CreateParameter().Returns(_ => new TestParameterMySQL());
...
/// </summary>
file sealed class TestParameterCollectionMySQL : IDataParameterCollection
{
...
/// </summary>
file sealed class TestParameterMySQL : IDbDataParameter
{
...
/// <summary>
/// Test entity for ADO.NET MySQL repository tests.
/// </summary>
...
public class GreaterThanTotalMySqlSpec : Specification<TestOrderMySQL>
{
    private readonly decimal _total;
    public GreaterThanTotalMySqlSpec(decimal total) => _total = total;
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => o.Total > _total;
}

public class LessThanTotalMySqlSpec : Specification<TestOrderMySQL>
{
    private readonly decimal _total;
    public LessThanTotalMySqlSpec(decimal total) => _total = total;
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => o.Total < _total;
}
...
public class TrueConstantMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => true;
}

public class FalseConstantMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => false;
}

public class DescriptionEqualsMySqlSpec : Specification<TestOrderMySQL>
{
    private readonly string _value;
    public DescriptionEqualsMySqlSpec(string value) => _value = value;
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => o.Description != null && o.Description.Equals(_value, StringComparison.Ordinal);
}

public class DescriptionEqualsNullMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
...
/// </summary>
public class TrimStringMethodMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
        => o => o.Description != null && o.Description.Trim() == "TEST";
}

public class UnsupportedBinaryOperatorMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
    {
        // XOR is not supported
        var param = Expression.Parameter(typeof(TestOrderMySQL), "o");
        var left = Expression.Property(param, nameof(TestOrderMySQL.IsActive));
        var right = Expression.Constant(true);
        var xor = Expression.ExclusiveOr(left, right);
        return Expression.Lambda<Func<TestOrderMySQL, bool>>(xor, param);
    }
}
...
/// </summary>
public class NegateOperatorMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
    {
        // Negate is handled via the Convert path in the switch expression
        var param = Expression.Parameter(typeof(TestOrderMySQL), "o");
        var total = Expression.Property(param, nameof(TestOrderMySQL.Total));
        var negated = Expression.Negate(total);
        var comparison = Expression.GreaterThan(negated, Expression.Constant(0m));
        return Expression.Lambda<Func<TestOrderMySQL, bool>>(comparison, param);
    }
}

public class UnsupportedExpressionMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
    {
...
public class UnsupportedMethodCallMySqlSpec : Specification<TestOrderMySQL>
{
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
    {
...
public class NullableTotalMySqlSpec : Specification<TestOrderMySQL>
{
    private readonly decimal? _total;
    public NullableTotalMySqlSpec(decimal? total) => _total = total;
    public override Expression<Func<TestOrderMySQL, bool>> ToExpression()
