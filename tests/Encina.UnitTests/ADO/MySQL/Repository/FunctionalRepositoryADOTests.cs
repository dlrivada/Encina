...
/// <summary>
/// Unit tests for <see cref="FunctionalRepositoryADO{TEntity, TId}"/> for MySQL.
...
public class FunctionalRepositoryADOTests : IDisposable
{
    ...
    private readonly IEntityMapping<TestEntityMySqlADO, Guid> _mapping;
    private readonly FunctionalRepositoryADO<TestEntityMySqlADO, Guid> _repository;
    ...
    public FunctionalRepositoryADOTests()
    {
        ...
        _mapping = new EntityMappingBuilder<TestEntityMySqlADO, Guid>()
        ...
        _repository = new FunctionalRepositoryADO<TestEntityMySqlADO, Guid>(_mockConnection, _mapping);
    }
    ...
    public void Constructor_NullConnection_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new FunctionalRepositoryADO<TestEntityMySqlADO, Guid>(null!, _mapping));
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new FunctionalRepositoryADO<TestEntityMySqlADO, Guid>(connection, null!));
    }
    ...
    {
        // Arrange
        var spec = new ActiveEntityMySqlSpec();
    ...
    {
        // Arrange
        var spec = new UnsupportedMySqlSpec();
    ...
    public async Task AddAsync_DuplicateKey_ReturnsLeftWithAlreadyExistsError()
    {
        // Arrange
        var entity = CreateTestEntity();
        // MySQL error 1062 = ER_DUP_ENTRY (Duplicate entry for key)
        // We use InvalidOperationException with a message containing "Duplicate entry" for the mock
        _mockCommand.ExecuteNonQuery().Throws(new InvalidOperationException("Duplicate entry for key"));
    ...
    public async Task DeleteAsync_ByEntity_NullEntity_ThrowsArgumentNullException()
    {
        // Act & Assert
        await Should.ThrowAsync<ArgumentNullException>(async () =>
            await _repository.DeleteAsync((TestEntityMySqlADO)null!));
    }
    ...
    private static TestEntityMySqlADO CreateTestEntity(
        string name = "Test Entity",
        bool isActive = true,
        decimal amount = 100m)
    {
        return new TestEntityMySqlADO
        {
            Id = Guid.NewGuid(),
            Name = name,
            Amount = amount,
...
/// <summary>
/// Test entity for ADO.NET MySQL repository unit tests.
/// </summary>
public class TestEntityMySqlADO
{
...
/// <summary>
/// Specification for active entities (MySQL ADO tests).
/// </summary>
public class ActiveEntityMySqlSpec : Specification<TestEntityMySqlADO>
{
...
/// <summary>
/// Specification for minimum amount (MySQL ADO tests).
/// </summary>
public class MinAmountMySqlSpec : Specification<TestEntityMySqlADO>
{
    private readonly decimal _minAmount;

    public MinAmountMySqlSpec(decimal minAmount) => _minAmount = minAmount;
