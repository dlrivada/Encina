...
public sealed class TenantAwareSpecificationSqlBuilderTests
{
    ...
    private readonly ITenantEntityMapping<MySQLTenantTestOrder, object> _tenantMapping;
    private readonly ITenantEntityMapping<MySQLTenantTestOrder, object> _nonTenantMapping;
    ...
    public TenantAwareSpecificationSqlBuilderTests()
    {
        ...
        var tenantMappingBuilder = new TenantEntityMappingBuilder<MySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
        ...
        _tenantMapping = new MySQLGenericTenantMappingAdapter<MySQLTenantTestOrder, Guid>(tenantMapping);

        // Create non-tenant entity mapping
        var nonTenantMappingBuilder = new TenantEntityMappingBuilder<MySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
            .MapProperty(o => o.CustomerId)
            .MapProperty(o => o.Total);
        ...
        _nonTenantMapping = new MySQLGenericTenantMappingAdapter<MySQLTenantTestOrder, Guid>(nonTenantMapping);
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(null!, _tenantProvider, _options));
    }
    ...
    public void Constructor_NullTenantProvider_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_tenantMapping, null!, _options));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_tenantMapping, _tenantProvider, null!));
    }
    ...
    public void BuildWhereClause_WithTenantContext_IncludesTenantFilter()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new MySQLActiveOrdersSpec();

        // Act
        var (whereClause, addParameters) = builder.BuildWhereClause(spec);

        // Assert - MySQL uses backticks for quoting
    ...
    public void BuildWhereClause_WithoutTenantContext_ThrowsException_WhenConfigured()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_tenantMapping, _tenantProvider, options);
        var spec = new MySQLActiveOrdersSpec();
    ...
    public void BuildWhereClause_NonTenantEntity_NoFilter()
    {
        // Arrange
        _tenantProvider.GetCurrentTenantId().Returns("tenant-123");
        var builder = new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_nonTenantMapping, _tenantProvider, _options);
        var spec = new MySQLActiveOrdersSpec();
    ...
    public void BuildSelectStatement_WithSpecification_CombinesFilters()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<MySQLTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new MySQLMinTotalSpec(100m);
    ...
    private static IDbCommand CreateMockCommand()
    {
        ...
        var parameters = new MySQLTestParameterCollection();
...
/// </summary>
internal sealed class MySQLGenericTenantMappingAdapter<TEntity, TId> : ITenantEntityMapping<TEntity, object>
    where TEntity : class
    where TId : notnull
{
    private readonly ITenantEntityMapping<TEntity, TId> _innerMapping;

    public MySQLGenericTenantMappingAdapter(ITenantEntityMapping<TEntity, TId> innerMapping)
    {
...
/// </summary>
internal sealed class MySQLTestParameterCollection : List<object>, IDataParameterCollection
{
...
/// <summary>
/// Specification that filters for active MySQL tenant orders.
/// </summary>
internal sealed class MySQLActiveOrdersSpec : Specification<MySQLTenantTestOrder>
{
    public override Expression<Func<MySQLTenantTestOrder, bool>> ToExpression()
        => o => o.IsActive;
}
...
/// </summary>
internal sealed class MySQLMinTotalSpec : Specification<MySQLTenantTestOrder>
{
    private readonly decimal _minTotal;

    public MySQLMinTotalSpec(decimal minTotal) => _minTotal = minTotal;
