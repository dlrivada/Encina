...
public sealed class TenantEntityMappingBuilderTests
{
    ...
    {
        var mapping = new TenantEntityMappingBuilder<MySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
    ...
    {
        var builder = new TenantEntityMappingBuilder<MySQLTenantTestOrder, Guid>()
            .HasId(o => o.Id)
            .HasTenantId(o => o.TenantId);
    ...
    public void GetTenantId_ReturnsCorrectTenantIdValue()
    {
        ...
        var order = new MySQLTenantTestOrder { Id = Guid.NewGuid(), TenantId = "tenant-123" };
    ...
    public void SetTenantId_SetsCorrectTenantIdValue()
    {
        ...
        var order = new MySQLTenantTestOrder { Id = Guid.NewGuid() };
...
/// <summary>
/// Test entity implementing <see cref="ITenantEntity"/> for ADO.NET MySQL tenancy tests.
/// </summary>
public sealed class MySQLTenantTestOrder : ITenantEntity
{
