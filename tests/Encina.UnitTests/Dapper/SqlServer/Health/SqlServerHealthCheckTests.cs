...
namespace Encina.UnitTests.Dapper.SqlServer.Health;

/// <summary>
/// Unit tests for <see cref="SqlServerHealthCheck"/>.
/// </summary>
public sealed class SqlServerHealthCheckTests
{
    ...
    {
        // Act
        var healthCheck = new SqlServerHealthCheck(_serviceProvider, null);

        // Assert
        healthCheck.Name.ShouldBe(SqlServerHealthCheck.DefaultName);
    }
    ...
    {
        // Arrange
        var options = new ProviderHealthCheckOptions { Name = "custom-sqlserver" };

        // Act
        var healthCheck = new SqlServerHealthCheck(_serviceProvider, options);

        // Assert
        healthCheck.Name.ShouldBe("custom-sqlserver");
    }
