...
namespace Encina.UnitTests.Dapper.SqlServer;
...
{
    private const string ValidConnectionString = "Server=localhost;Database=test;User Id=sa;Password=Test@123;TrustServerCertificate=True";
