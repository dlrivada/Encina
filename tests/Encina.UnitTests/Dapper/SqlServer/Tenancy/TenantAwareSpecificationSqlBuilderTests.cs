...
public sealed class TenantAwareSpecificationSqlBuilderTests
{
    ...
    private readonly ITenantEntityMapping<TenantTestOrder, object> _tenantMapping;
    private readonly ITenantEntityMapping<TenantTestOrder, object> _nonTenantMapping;
    ...
    public TenantAwareSpecificationSqlBuilderTests()
    {
        ...
        var tenantMappingBuilder = new TenantEntityMappingBuilder<TenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
        ...
        var nonTenantMappingBuilder = new TenantEntityMappingBuilder<TenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
            .MapProperty(o => o.CustomerId)
            .MapProperty(o => o.Total);
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(null!, _tenantProvider, _options));
    }
    ...
    public void Constructor_NullTenantProvider_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_tenantMapping, null!, _options));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_tenantMapping, _tenantProvider, null!));
    }
    ...
    public void BuildWhereClause_WithTenantContext_IncludesTenantFilter()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new TenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_WithoutTenantContext_ThrowsException_WhenConfigured()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_tenantMapping, _tenantProvider, options);
        var spec = new TenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_NonTenantEntity_NoFilter()
    {
        // Arrange
        _tenantProvider.GetCurrentTenantId().Returns("tenant-123");
        var builder = new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_nonTenantMapping, _tenantProvider, _options);
        var spec = new TenantActiveOrdersSpec();
    ...
    public void BuildSelectStatement_WithSpecification_CombinesFilters()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<TenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new TenantMinTotalSpec(100m);
...
/// </summary>
internal sealed class TenantActiveOrdersSpec : Specification<TenantTestOrder>
{
    public override Expression<Func<TenantTestOrder, bool>> ToExpression()
        => o => o.IsActive;
}
...
/// </summary>
internal sealed class TenantMinTotalSpec : Specification<TenantTestOrder>
{
    private readonly decimal _minTotal;

    public TenantMinTotalSpec(decimal minTotal) => _minTotal = minTotal;
