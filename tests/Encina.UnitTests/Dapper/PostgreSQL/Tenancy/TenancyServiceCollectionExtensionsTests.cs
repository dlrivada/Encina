...
public sealed class TenancyServiceCollectionExtensionsTests
{
    ...
    public void AddTenantAwareRepository_RegistersRepositoryWithCorrectMapping()
    {
        ...
        // Act
        services.AddTenantAwareRepository<DapperPostgreSQLTenantTestOrder, Guid>(mapping =>
        ...
        var entityMapping = provider.GetService<ITenantEntityMapping<DapperPostgreSQLTenantTestOrder, Guid>>();
        ...
        var repository = provider.GetService<IFunctionalRepository<DapperPostgreSQLTenantTestOrder, Guid>>();
        repository.ShouldNotBeNull();
        repository.ShouldBeOfType<TenantAwareFunctionalRepositoryDapper<DapperPostgreSQLTenantTestOrder, Guid>>();
    }
    ...
    public void AddTenantAwareRepository_RegistersReadRepositoryInterface()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var readRepository = provider.GetService<IFunctionalReadRepository<DapperPostgreSQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareReadRepository_RegistersOnlyReadRepository()
    {
        ...
        // Act
        services.AddTenantAwareReadRepository<DapperPostgreSQLTenantTestOrder, Guid>(mapping =>
        ...
        var fullRepository = provider.GetService<IFunctionalRepository<DapperPostgreSQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_WithNonTenantEntity_CreatesNonTenantAwareMapping()
    {
        ...
        services.AddTenantAwareRepository<DapperPostgreSQLTenantTestOrder, Guid>(mapping =>
            mapping.ToTable("global_orders")
                   .HasId(o => o.Id)
                   .MapProperty(o => o.CustomerId));

        // Assert
        var provider = services.BuildServiceProvider();
        var entityMapping = provider.GetRequiredService<ITenantEntityMapping<DapperPostgreSQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddTenantAwareRepository<DapperPostgreSQLTenantTestOrder, Guid>(
    ...
    public void AddTenantAwareRepository_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddTenantAwareRepository<DapperPostgreSQLTenantTestOrder, Guid>(null!));
    }
}
