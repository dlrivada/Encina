...
public sealed class TenantConnectionFactoryTests
{
    ...
    public TenantConnectionFactoryTests()
    {
        ...
        {
            DefaultConnectionString = "Host=localhost;Database=default_db;Username=test;Password=test"
        });
    }
...
#pragma warning restore CA2012
        ...
        result.Match(Right: cs => cs.ShouldBe("Host=localhost;Database=default_db;Username=test;Password=test"), Left: _ => { });
    }
...
#pragma warning restore CA2012
    ...
    public async Task GetConnectionStringAsync_DatabasePerTenant_ReturnsTenantConnectionString()
    {
        ...
        var tenant = new TenantInfo(
            ...
            ConnectionString: "Host=tenant1.postgres.local;Database=tenant1_db;Username=tenant1;Password=secret");
...
#pragma warning restore CA2012
        ...
        // Assert
        result.IsRight.ShouldBeTrue();
        result.Match(Right: cs => cs.ShouldBe("Host=tenant1.postgres.local;Database=tenant1_db;Username=tenant1;Password=secret"), Left: _ => { });
    }
...
#pragma warning restore CA2012
        ...
        result.Match(
            Right: connection =>
            {
                ...
                connection.ConnectionString.ShouldBe("Host=localhost;Database=default_db;Username=test;Password=test");
            },
            Left: _ => { });
    }
    ...
    public async Task CreateConnectionForTenantAsync_WithValidTenant_ReturnsConnection()
    {
        ...
        var tenant = new TenantInfo(
            ...
            Strategy: TenantIsolationStrategy.DatabasePerTenant,
            ConnectionString: "Host=specific.postgres.local;Database=specific_db;Username=specific;Password=secret");
...
#pragma warning restore CA2012
        ...
        result.Match(
            ...
            {
                connection.ShouldNotBeNull();
                connection.ConnectionString.ShouldBe("Host=specific.postgres.local;Database=specific_db;Username=specific;Password=secret");
            },
            Left: _ => { });
    }
