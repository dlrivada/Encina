...
public sealed class TenantAwareSpecificationSqlBuilderTests
{
    ...
    private readonly ITenantEntityMapping<DapperSqliteTenantTestOrder, object> _tenantMapping;
    private readonly ITenantEntityMapping<DapperSqliteTenantTestOrder, object> _nonTenantMapping;
    ...
    public TenantAwareSpecificationSqlBuilderTests()
    {
        ...
        var tenantMappingBuilder = new TenantEntityMappingBuilder<DapperSqliteTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
        ...
        _tenantMapping = new SqliteGenericTenantMappingAdapter<DapperSqliteTenantTestOrder, Guid>(tenantMapping);

        // Create non-tenant entity mapping
        var nonTenantMappingBuilder = new TenantEntityMappingBuilder<DapperSqliteTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
            .MapProperty(o => o.CustomerId)
            .MapProperty(o => o.Total);
        ...
        _nonTenantMapping = new SqliteGenericTenantMappingAdapter<DapperSqliteTenantTestOrder, Guid>(nonTenantMapping);
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(null!, _tenantProvider, _options));
    }
    ...
    public void Constructor_NullTenantProvider_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_tenantMapping, null!, _options));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_tenantMapping, _tenantProvider, null!));
    }
    ...
    public void BuildWhereClause_WithTenantContext_IncludesTenantFilter()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new SqliteTenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_WithoutTenantContext_ThrowsException_WhenConfigured()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_tenantMapping, _tenantProvider, options);
        var spec = new SqliteTenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_NonTenantEntity_NoFilter()
    {
        // Arrange
        _tenantProvider.GetCurrentTenantId().Returns("tenant-123");
        var builder = new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_nonTenantMapping, _tenantProvider, _options);
        var spec = new SqliteTenantActiveOrdersSpec();
    ...
    public void BuildSelectStatement_WithSpecification_CombinesFilters()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperSqliteTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new SqliteTenantMinTotalSpec(100m);
...
/// </summary>
internal sealed class SqliteTenantActiveOrdersSpec : Specification<DapperSqliteTenantTestOrder>
{
    public override Expression<Func<DapperSqliteTenantTestOrder, bool>> ToExpression()
        => o => o.IsActive;
}
...
/// </summary>
internal sealed class SqliteTenantMinTotalSpec : Specification<DapperSqliteTenantTestOrder>
{
    private readonly decimal _minTotal;

    public SqliteTenantMinTotalSpec(decimal minTotal) => _minTotal = minTotal;
