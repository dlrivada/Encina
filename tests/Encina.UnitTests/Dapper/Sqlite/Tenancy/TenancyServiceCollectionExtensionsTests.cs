...
public sealed class TenancyServiceCollectionExtensionsTests
{
    ...
    public void AddTenantAwareRepository_RegistersRepositoryWithCorrectMapping()
    {
        ...
        // Act
        services.AddTenantAwareRepository<DapperSqliteTenantTestOrder, Guid>(mapping =>
        ...
        var entityMapping = provider.GetService<ITenantEntityMapping<DapperSqliteTenantTestOrder, Guid>>();
        ...
        var repository = provider.GetService<IFunctionalRepository<DapperSqliteTenantTestOrder, Guid>>();
        repository.ShouldNotBeNull();
        repository.ShouldBeOfType<TenantAwareFunctionalRepositoryDapper<DapperSqliteTenantTestOrder, Guid>>();
    }
    ...
    public void AddTenantAwareRepository_RegistersReadRepositoryInterface()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var readRepository = provider.GetService<IFunctionalReadRepository<DapperSqliteTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareReadRepository_RegistersOnlyReadRepository()
    {
        ...
        // Act
        services.AddTenantAwareReadRepository<DapperSqliteTenantTestOrder, Guid>(mapping =>
        ...
        var fullRepository = provider.GetService<IFunctionalRepository<DapperSqliteTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_WithNonTenantEntity_CreatesNonTenantAwareMapping()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var entityMapping = provider.GetRequiredService<ITenantEntityMapping<DapperSqliteTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddTenantAwareRepository<DapperSqliteTenantTestOrder, Guid>(
    ...
    public void AddTenantAwareRepository_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddTenantAwareRepository<DapperSqliteTenantTestOrder, Guid>(null!));
    }
}
