...
public sealed class TenancyServiceCollectionExtensionsTests
{
    ...
    public void AddTenantAwareRepository_RegistersRepositoryWithCorrectMapping()
    {
        ...
        // Act
        services.AddTenantAwareRepository<DapperMySQLTenantTestOrder, Guid>(mapping =>
        ...
        var entityMapping = provider.GetService<ITenantEntityMapping<DapperMySQLTenantTestOrder, Guid>>();
        ...
        var repository = provider.GetService<IFunctionalRepository<DapperMySQLTenantTestOrder, Guid>>();
        repository.ShouldNotBeNull();
        repository.ShouldBeOfType<TenantAwareFunctionalRepositoryDapper<DapperMySQLTenantTestOrder, Guid>>();
    }
    ...
    public void AddTenantAwareRepository_RegistersReadRepositoryInterface()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var readRepository = provider.GetService<IFunctionalReadRepository<DapperMySQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareReadRepository_RegistersOnlyReadRepository()
    {
        ...
        // Act
        services.AddTenantAwareReadRepository<DapperMySQLTenantTestOrder, Guid>(mapping =>
        ...
        var fullRepository = provider.GetService<IFunctionalRepository<DapperMySQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_WithNonTenantEntity_CreatesNonTenantAwareMapping()
    {
        ...
        // Assert
        var provider = services.BuildServiceProvider();
        var entityMapping = provider.GetRequiredService<ITenantEntityMapping<DapperMySQLTenantTestOrder, Guid>>();
    ...
    public void AddTenantAwareRepository_NullServices_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            ((IServiceCollection)null!).AddTenantAwareRepository<DapperMySQLTenantTestOrder, Guid>(
    ...
    public void AddTenantAwareRepository_NullConfigure_ThrowsArgumentNullException()
    {
        ...
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            services.AddTenantAwareRepository<DapperMySQLTenantTestOrder, Guid>(null!));
    }
}
