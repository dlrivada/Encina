...
public sealed class TenantEntityMappingBuilderTests
{
    ...
    {
        var mapping = new TenantEntityMappingBuilder<DapperMySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
    ...
    {
        var builder = new TenantEntityMappingBuilder<DapperMySQLTenantTestOrder, Guid>()
            .HasId(o => o.Id)
            .HasTenantId(o => o.TenantId);
    ...
    public void GetTenantId_ReturnsCorrectTenantIdValue()
    {
        ...
        var order = new DapperMySQLTenantTestOrder { Id = Guid.NewGuid(), TenantId = "tenant-123" };
    ...
    public void SetTenantId_SetsCorrectTenantIdValue()
    {
        ...
        var order = new DapperMySQLTenantTestOrder { Id = Guid.NewGuid() };
        mapping.SetTenantId(order, "tenant-456");
        order.TenantId.ShouldBe("tenant-456");
    }
}

public sealed class DapperMySQLTenantTestOrder : ITenantEntity
{
