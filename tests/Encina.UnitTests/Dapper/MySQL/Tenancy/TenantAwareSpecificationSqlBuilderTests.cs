...
namespace Encina.UnitTests.Dapper.MySQL.Tenancy;
...
public sealed class TenantAwareSpecificationSqlBuilderTests
{
    ...
    private readonly ITenantEntityMapping<DapperMySQLTenantTestOrder, object> _tenantMapping;
    private readonly ITenantEntityMapping<DapperMySQLTenantTestOrder, object> _nonTenantMapping;
    ...
    public TenantAwareSpecificationSqlBuilderTests()
    {
        ...
        var tenantMappingBuilder = new TenantEntityMappingBuilder<DapperMySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
        ...
        _tenantMapping = new MySQLGenericTenantMappingAdapter<DapperMySQLTenantTestOrder, Guid>(tenantMapping);

        // Create non-tenant entity mapping
        var nonTenantMappingBuilder = new TenantEntityMappingBuilder<DapperMySQLTenantTestOrder, Guid>()
            .ToTable("Orders")
            .HasId(o => o.Id)
            .MapProperty(o => o.CustomerId)
            .MapProperty(o => o.Total);
        ...
        _nonTenantMapping = new MySQLGenericTenantMappingAdapter<DapperMySQLTenantTestOrder, Guid>(nonTenantMapping);
    }
    ...
    public void Constructor_NullMapping_ThrowsArgumentNullException()
    {
        ...
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(null!, _tenantProvider, _options));
    }
    ...
    public void Constructor_NullTenantProvider_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_tenantMapping, null!, _options));
    }
    ...
    public void Constructor_NullOptions_ThrowsArgumentNullException()
    {
        // Act & Assert
        Should.Throw<ArgumentNullException>(() =>
            new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_tenantMapping, _tenantProvider, null!));
    }
    ...
    public void BuildWhereClause_WithTenantContext_IncludesTenantFilter()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new MySQLTenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_WithoutTenantContext_ThrowsException_WhenConfigured()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_tenantMapping, _tenantProvider, options);
        var spec = new MySQLTenantActiveOrdersSpec();
    ...
    public void BuildWhereClause_NonTenantEntity_NoFilter()
    {
        // Arrange
        _tenantProvider.GetCurrentTenantId().Returns("tenant-123");
        var builder = new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_nonTenantMapping, _tenantProvider, _options);
        var spec = new MySQLTenantActiveOrdersSpec();
    ...
    public void BuildSelectStatement_WithSpecification_CombinesFilters()
    {
        ...
        var builder = new TenantAwareSpecificationSqlBuilder<DapperMySQLTenantTestOrder>(_tenantMapping, _tenantProvider, _options);
        var spec = new MySQLTenantMinTotalSpec(100m);
...
/// </summary>
internal sealed class MySQLTenantActiveOrdersSpec : Specification<DapperMySQLTenantTestOrder>
{
    public override Expression<Func<DapperMySQLTenantTestOrder, bool>> ToExpression()
        => o => o.IsActive;
}
...
/// </summary>
internal sealed class MySQLTenantMinTotalSpec : Specification<DapperMySQLTenantTestOrder>
{
    private readonly decimal _minTotal;

    public MySQLTenantMinTotalSpec(decimal minTotal) => _minTotal = minTotal;
