...
/// <summary>
/// Unit tests for <see cref="PostgreSqlPermissionScriptGenerator"/>.
/// Uses snapshot testing to verify generated SQL scripts.
/// </summary>
public class PostgreSqlPermissionScriptGeneratorTests
{
    private readonly PostgreSqlPermissionScriptGenerator _generator = new();
    ...
    {
        _generator.ProviderName.ShouldBe("PostgreSql");
    }
    ...
    [Fact]
    public void GenerateGrantPermissionsScript_ShouldIncludeAlterDefaultPrivileges()
    {
        // Arrange
        var options = new ModuleIsolationOptions();
        options.AddModuleSchema(new ModuleSchemaOptions
    ...
    [Fact]
    public void GenerateGrantPermissionsScript_ShouldIncludeSequencePermissions()
    {
        // Arrange
        var options = new ModuleIsolationOptions();
        options.AddModuleSchema(new ModuleSchemaOptions
        ...
        // Assert
        script.Content.ShouldContain("ALL SEQUENCES");
    }

    [Fact]
    public void GenerateUserCreationScript_ShouldUseRolesNotUsers()
    {
        // Arrange
        var options = new ModuleIsolationOptions();
        options.AddModuleSchema(new ModuleSchemaOptions
        ...
        // Assert
        script.Content.ShouldContain("CREATE ROLE");
        script.Content.ShouldContain("WITH LOGIN");
    }
