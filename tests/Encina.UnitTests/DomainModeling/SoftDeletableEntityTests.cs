...
public class SoftDeletableEntityTests
{
    private sealed class TestSoftDeletableEntity : SoftDeletableEntity<Guid>
    {
        ...
        public TestSoftDeletableEntity(Guid id, TimeProvider? timeProvider = null)
    ...
    public void Delete_ShouldSetDeletedAtUtcToCurrentTime()
    {
        ...
        var entity = new TestSoftDeletableEntity(Guid.NewGuid(), fakeTimeProvider);
    ...
    public void Entity_ShouldHaveCorrectId()
    {
        ...
        // Act
        var entity = new TestSoftDeletableEntity(id);
    ...
    public void Entity_Equality_ShouldBeBasedOnId()
    {
        // Arrange
        var id = Guid.NewGuid();
        var entity1 = new TestSoftDeletableEntity(id) { Name = "Entity1" };
        var entity2 = new TestSoftDeletableEntity(id) { Name = "Entity2" };
