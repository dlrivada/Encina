...
public sealed class EncinaConfigurationTests
{
    ...
    {
        var configuration = new EncinaConfiguration();
        var method = typeof(EncinaConfiguration)
    ...
    public void RegisterServicesFromAssemblyContaining_AddsAssembly()
    {
        ...
        configuration.RegisterServicesFromAssemblyContaining<EncinaConfigurationTests>();

        GetAssemblies(configuration).ShouldContain(typeof(EncinaConfigurationTests).Assembly);
    }
    ...
    private static IList<Type> GetMutablePipelineTypes(EncinaConfiguration configuration)
    {
        var field = typeof(EncinaConfiguration)
    ...
    private static IList<Type> GetMutablePreProcessorTypes(EncinaConfiguration configuration)
    {
        var field = typeof(EncinaConfiguration)
    ...
    private static void InvokeInternal(EncinaConfiguration configuration, string methodName, IServiceCollection services)
    {
        var method = typeof(EncinaConfiguration)
