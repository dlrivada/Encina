...
namespace SimpleMediator.Refit.ContractTests;
...
{
    [Fact]
    public void Contract_AddSimpleMediatorRefitClient_MustReturnIHttpClientBuilder()
    {
        // Arrange
        var method = typeof(ServiceCollectionExtensions).GetMethod(
            "AddSimpleMediatorRefitClient",
    ...
    [Fact]
    public void Contract_AddSimpleMediatorRefitClient_WithRefitSettings_MustReturnIHttpClientBuilder()
    {
        // Arrange
        var method = typeof(ServiceCollectionExtensions).GetMethod(
            "AddSimpleMediatorRefitClient",
    ...
    [Fact]
    public void Contract_AddSimpleMediatorRefitClient_WithSettingsProvider_MustReturnIHttpClientBuilder()
    {
        // Arrange
        var method = typeof(ServiceCollectionExtensions).GetMethod(
            "AddSimpleMediatorRefitClient",
    ...
    public void Contract_AllOverloads_MustBeExtensionMethods()
    {
        ...
        var methods = typeof(ServiceCollectionExtensions).GetMethods(BindingFlags.Public | BindingFlags.Static)
            .Where(m => m.Name == "AddSimpleMediatorRefitClient");
    ...
    public void Contract_TApiClient_MustHaveClassConstraint()
    {
        ...
        var method = typeof(ServiceCollectionExtensions).GetMethods(BindingFlags.Public | BindingFlags.Static)
            .First(m => m.Name == "AddSimpleMediatorRefitClient");
