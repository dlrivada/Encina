...
namespace Encina.ADO.PostgreSQL.Tests.Inbox;

/// <summary>
/// Property-based tests for <see cref="InboxStoreADO"/>.
/// Verifies invariants and properties across various inputs.
/// </summary>
public sealed class InboxStoreADOPropertyTests : IClassFixture<PostgreSqlFixture>
{
    private readonly PostgreSqlFixture _database;
    private readonly InboxStoreADO _store;

    public InboxStoreADOPropertyTests(PostgreSqlFixture database)
    {
        _database = database;
