...
namespace Encina.Dapper.SqlServer.Benchmarks.Infrastructure;

/// <summary>
/// Spins up a throwaway SQL Server container for Dapper benchmark execution.
/// </summary>
/// <remarks>
/// Mirrors <c>tests/Encina.BenchmarkTests/Encina.ADO.SqlServer.Benchmarks/Infrastructure/SqlServerBenchmarkContainer.cs</c>
/// and <c>tests/Encina.TestInfrastructure/Fixtures/SqlServerFixture.cs</c> for parity with
/// the ADO SqlServer benchmarks and integration tests
/// (<c>mcr.microsoft.com/mssql/server:2022-latest</c>).
/// </remarks>
