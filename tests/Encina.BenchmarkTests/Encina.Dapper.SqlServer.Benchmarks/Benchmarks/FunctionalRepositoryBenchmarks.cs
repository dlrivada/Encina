...
/// on <see cref="FunctionalRepositoryDapper{TEntity, TId}"/> against SQL Server. These two
...
public class FunctionalRepositoryBenchmarks
{
    ...
    [BenchmarkCategory("DocRef:bench:dapper-sqlserver/repo-get-by-id")]
    ...
    [Benchmark]
    [BenchmarkCategory("DocRef:bench:dapper-sqlserver/repo-add")]
