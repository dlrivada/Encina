...
/// on <see cref="FunctionalRepositoryADO{TEntity, TId}"/> against MySQL. These two operations
/// dominate the per-request cost of any repository-based command handler.
/// </summary>
[MemoryDiagnoser]
public class FunctionalRepositoryBenchmarks
{
    ...
    [BenchmarkCategory("DocRef:bench:ado-mysql/repo-get-by-id")]
    ...
    [Benchmark]
    [BenchmarkCategory("DocRef:bench:ado-mysql/repo-add")]
