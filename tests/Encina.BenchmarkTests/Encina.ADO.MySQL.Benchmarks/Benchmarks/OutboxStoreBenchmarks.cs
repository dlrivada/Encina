...
/// <summary>
/// Measures the cost of the Encina outbox pattern on MySQL — both the "write" path
...
public class OutboxStoreBenchmarks
{
    ...
    public void GlobalSetup()
    {
        ...
        _connection.Open();
        AdoSchemaBuilder.CreateOutboxTable(_connection, DatabaseProvider.MySql);
    ...
    [BenchmarkCategory("DocRef:bench:ado-mysql/outbox-insert")]
    ...
    [Benchmark]
    [BenchmarkCategory("DocRef:bench:ado-mysql/outbox-query-pending")]
