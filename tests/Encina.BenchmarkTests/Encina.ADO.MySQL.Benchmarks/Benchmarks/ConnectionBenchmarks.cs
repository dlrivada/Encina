...
/// <summary>
/// Measures the baseline cost of opening a MySQL connection through <see cref="MySqlConnector"/>.
...
public class ConnectionBenchmarks
{
    ...
    /// <summary>
    /// Baseline: open a fresh <see cref="MySqlConnection"/>, execute <c>SELECT 1</c>, and dispose.
    ...
    [BenchmarkCategory("DocRef:bench:ado-mysql/connection-open")]
