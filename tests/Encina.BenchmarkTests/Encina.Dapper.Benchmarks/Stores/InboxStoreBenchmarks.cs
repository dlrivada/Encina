...
/// <summary>
/// Benchmarks for Dapper InboxStore operations.
/// </summary>
[MemoryDiagnoser]
[RankColumn]
public class InboxStoreBenchmarks
{
    ...
    {
        _connection = DapperConnectionFactory.CreateSharedMemorySqliteConnection("inbox_dapper_benchmark");
        ProviderTypeHandlers.EnsureRegistered(DatabaseProvider.Sqlite);
        DapperSchemaBuilder.CreateInboxTable(_connection, DatabaseProvider.Sqlite);
