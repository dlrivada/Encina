...
/// <summary>
/// Benchmarks for ADO.NET SagaStore operations.
/// </summary>
[MemoryDiagnoser]
[RankColumn]
public class SagaStoreBenchmarks
{
    ...
    {
        _connection = AdoConnectionFactory.CreateSharedMemorySqliteConnection("saga_ado_benchmark");
        AdoSchemaBuilder.CreateSagaTable(_connection, DatabaseProvider.Sqlite);
        ...
        _store = new SagaStoreADO(_connection);
    }
