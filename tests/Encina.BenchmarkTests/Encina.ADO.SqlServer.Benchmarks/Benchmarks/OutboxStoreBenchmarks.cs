...
/// <summary>
/// Measures the cost of the Encina outbox pattern on SQL Server — both the "write" path
...
public class OutboxStoreBenchmarks
{
    ...
    public void GlobalSetup()
    {
        ...
        _connection.Open();
        AdoSchemaBuilder.CreateOutboxTable(_connection, DatabaseProvider.SqlServer);
    ...
    [BenchmarkCategory("DocRef:bench:ado-sqlserver/outbox-insert")]
    ...
    [Benchmark]
    [BenchmarkCategory("DocRef:bench:ado-sqlserver/outbox-query-pending")]
