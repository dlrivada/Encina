...
- `tests/Encina.BenchmarkTests/Encina.Benchmarks/Outbox/OutboxDapperBenchmarks.cs` - Dapper-specific
- `tests/Encina.BenchmarkTests/Encina.Benchmarks/Outbox/OutboxEfCoreBenchmarks.cs` - EF Core-specific
- `tests/Encina.BenchmarkTests/Encina.Benchmarks/Inbox/InboxDapperBenchmarks.cs` - Dapper-specific
- `tests/Encina.BenchmarkTests/Encina.Benchmarks/Inbox/InboxEfCoreBenchmarks.cs` - EF Core-specific
