...
/// <summary>
/// Measures the cost of the Encina outbox pattern on Dapper + PostgreSQL — both the "write"
...
public class OutboxStoreBenchmarks
{
    ...
    public void GlobalSetup()
    {
        ...
        _connection.Open();
        DapperSchemaBuilder.CreateOutboxTable(_connection, DatabaseProvider.PostgreSql);
    ...
    [BenchmarkCategory("DocRef:bench:dapper-postgresql/outbox-insert")]
    ...
    [Benchmark]
    [BenchmarkCategory("DocRef:bench:dapper-postgresql/outbox-query-pending")]
