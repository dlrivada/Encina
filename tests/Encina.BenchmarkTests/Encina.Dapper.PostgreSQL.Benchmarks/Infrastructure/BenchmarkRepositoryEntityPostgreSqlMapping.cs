...
/// <summary>
/// PostgreSQL-specific <see cref="IEntityMapping{TEntity, TId}"/> for
/// <see cref="BenchmarkRepositoryEntity"/>. The shared umbrella project ships a SqlServer-typed
/// mapping; each provider must supply its own because each Dapper provider package defines its
/// own <c>IEntityMapping</c> interface in a provider-specific namespace.
/// </summary>
public sealed class BenchmarkRepositoryEntityPostgreSqlMapping : IEntityMapping<BenchmarkRepositoryEntity, Guid>
{
    /// <inheritdoc />
