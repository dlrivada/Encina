...
/// <summary>
/// Load tests for <see cref="OutboxStoreDapper"/>.
/// Verifies behavior under high concurrency, race conditions, and volume.
/// </summary>
[Trait("Category", "Load")]
[Trait("TestType", "Load")]
[Trait("Provider", "Dapper.PostgreSQL")]
public sealed class OutboxStoreDapperLoadTests : IClassFixture<PostgreSqlFixture>
{
    private readonly ITestOutputHelper _output;
    private readonly PostgreSqlFixture _fixture;
    private readonly OutboxStoreDapper _store;

    public OutboxStoreDapperLoadTests(PostgreSqlFixture fixture, ITestOutputHelper output)
    {
        _fixture = fixture;
        _output = output;
