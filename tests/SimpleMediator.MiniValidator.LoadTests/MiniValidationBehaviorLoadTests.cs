...
namespace SimpleMediator.MiniValidator.LoadTests;

/// <summary>
/// Load tests for MiniValidationBehavior using NBomber.
/// Verifies performance, concurrency, and throughput under stress conditions.
/// </summary>
[Trait("Category", "Load")]
public sealed class MiniValidationBehaviorLoadTests
{
    private readonly ITestOutputHelper _output;

    public MiniValidationBehaviorLoadTests(ITestOutputHelper output)
    {
        _output = output;
    }
    ...
    public void ComplexValidation_HighLoad_ShouldValidateCorrectly()
    {
        ...
        var services = new ServiceCollection();
        services.AddSimpleMediator();
        services.AddTransient<MiniValidationBehavior<ComplexCommand, Guid>>();
        ...
        services.AddTransient<IPipelineBehavior<ComplexCommand, Guid>>(sp =>
            sp.GetRequiredService<MiniValidationBehavior<ComplexCommand, Guid>>());
