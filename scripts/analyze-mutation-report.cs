...
{
    Console.Error.WriteLine("Stryker output folder not found. Run Stryker before using this script.");
    return;
}
...
{
    Console.Error.WriteLine("No Stryker runs found under StrykerOutput.");
    return;
}
