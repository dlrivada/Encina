...
- ✅ Database Sharding [#289](https://github.com/dlrivada/Encina/issues/289) - 4 routing strategies (Hash/Range/Directory/Geo), compound shard keys (#641), distributed aggregation helpers (#640), 13 providers, MongoDB dual-mode, scatter-gather, IShardRebalancer, 9 metric instruments, 5 trace activities, ~780+ tests
