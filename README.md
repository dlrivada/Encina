...
- **Database Sharding**: Horizontal partitioning with 4 routing strategies (Hash, Range, Directory, Geo), scatter-gather queries, and MongoDB dual-mode across all 13 providers (see [docs](docs/sharding/configuration.md))
