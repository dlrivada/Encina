...
/// <summary>
/// Dapper type handler for <see cref="SnowflakeId"/> values in SQLite.
/// SQLite stores Snowflake IDs as INT64, so this handler converts between <see cref="SnowflakeId"/> and <see cref="long"/>.
/// </summary>
