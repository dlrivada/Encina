...
/// <summary>
/// Dapper type handler for <see cref="ShardPrefixedId"/> values in SQLite.
/// SQLite stores shard-prefixed IDs as TEXT, so this handler converts between <see cref="ShardPrefixedId"/> and <see cref="string"/>.
/// </summary>
