...
namespace Encina.Dapper.Sqlite.ABAC;

/// <summary>
/// SQLite Dapper implementation of <see cref="IPolicyStore"/> for persistent ABAC policy storage.
...
/// DateTime values are handled by Dapper's SQLite type mapping (ISO 8601 text).
/// </para>
/// </remarks>
