...
/// <summary>
/// Tenant-aware SQL builder that automatically prepends tenant filters to queries for SQLite.
/// </summary>
    ...
    where TEntity : class
{
    ...
    /// <summary>
    /// Builds a pagination clause from a query specification (LIMIT/OFFSET for SQLite).
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
