...
/// <summary>
/// ADO.NET implementation of <see cref="IReadAuditStore"/> for SQLite.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class ReadAuditStoreADO : IReadAuditStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            AddParameter(command, "@AccessedAtUtc", entity.AccessedAtUtc.ToString("o", CultureInfo.InvariantCulture));
    ...
    private static ReadAuditEntry MapToEntry(IDataReader reader)
    {
        var entity = new ReadAuditEntryEntity
        {
            ...
            AccessedAtUtc = DateTimeOffset.Parse(reader.GetString(reader.GetOrdinal("AccessedAtUtc")), CultureInfo.InvariantCulture),
