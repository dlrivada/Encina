...
/// <summary>
/// Dapper implementation of <see cref="IRetentionPolicyStore"/> for SQL Server.
...
/// <list type="bullet">
/// <item><description>DateTimeOffset values are passed directly (native support).</description></item>
/// <item><description>Boolean values are passed directly (bit type).</description></item>
/// <item><description>GUID and integer types are cast directly from dynamic rows.</description></item>
/// </list>
/// </para>
/// </remarks>
