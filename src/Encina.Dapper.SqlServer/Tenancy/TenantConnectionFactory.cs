...
/// <summary>
/// SQL Server implementation of <see cref="ITenantConnectionFactory"/> for multi-tenant
/// database connection management.
/// </summary>
/// <remarks>
/// <para>
/// This factory creates <see cref="SqlConnection"/> instances configured for the current
...
public sealed class TenantConnectionFactory : ITenantConnectionFactory
{
    ...
    public async ValueTask<Either<EncinaError, IDbConnection>> CreateConnectionAsync(CancellationToken cancellationToken = default)
    {
        ...
        return connectionStringResult.Map(cs => (IDbConnection)new SqlConnection(cs));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return GetConnectionStringForTenant(tenant)
            .Map(cs => (IDbConnection)new SqlConnection(cs));
    }
