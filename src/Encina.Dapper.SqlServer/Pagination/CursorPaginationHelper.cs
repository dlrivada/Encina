...
namespace Encina.Dapper.SqlServer.Pagination;

/// <summary>
/// Helper class for executing cursor-paginated queries using Dapper with SQL Server.
/// </summary>
/// <remarks>
/// <para>
...
/// <list type="bullet">
/// <item><description>Uses square brackets for identifiers: [ColumnName]</description></item>
/// <item><description>Uses TOP for row limiting</description></item>
    ...
    where TEntity : class
{
        ...
        string? columns)
    {
        ...
        {
            $"SELECT TOP ({pageSize + 1}) {selectColumns} FROM [{validatedTable}]"
        };
