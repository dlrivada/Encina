...
/// <summary>
/// Dapper implementation of <see cref="IDataLocationStore"/> for SQL Server.
/// Provides persistence for data location records to track where data entities
/// are physically stored and processed.
/// </summary>
/// <remarks>
/// <para>
/// Per GDPR Article 30(1)(e), the controller must maintain records of processing
/// activities including "where applicable, transfers of personal data to a third country".
/// Data location records provide the foundation for demonstrating that data resides
/// only in approved regions.
/// </para>
/// <para>
...
public sealed class DataLocationStoreDapper : IDataLocationStore
{
    ...
    private static DataLocationEntity MapToEntity(dynamic row)
    {
        return new DataLocationEntity
        {
            ...
            LastVerifiedAtUtc = row.LastVerifiedAtUtc is null or DBNull ? null : new DateTimeOffset((DateTime)row.LastVerifiedAtUtc, TimeSpan.Zero),
