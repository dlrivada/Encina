...
/// <summary>
/// Dapper type handler for <see cref="UuidV7Id"/> values in SQL Server.
/// SQL Server stores UUIDv7 values as UNIQUEIDENTIFIER (Guid), so this handler converts between <see cref="UuidV7Id"/> and <see cref="Guid"/>.
/// </summary>
