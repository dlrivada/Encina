...
/// <summary>
/// Dapper type handler for <see cref="ShardPrefixedId"/> values in SQL Server.
/// SQL Server stores shard-prefixed IDs as NVARCHAR, so this handler converts between <see cref="ShardPrefixedId"/> and <see cref="string"/>.
/// </summary>
