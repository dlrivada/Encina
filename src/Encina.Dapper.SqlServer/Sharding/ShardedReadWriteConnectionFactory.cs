...
/// <summary>
/// SQL Server Dapper implementation of <see cref="IShardedReadWriteConnectionFactory"/> that
/// combines shard routing with read/write separation.
/// </summary>
/// <remarks>
/// <para>
/// Creates <see cref="SqlConnection"/> instances (returned as <see cref="IDbConnection"/>)
