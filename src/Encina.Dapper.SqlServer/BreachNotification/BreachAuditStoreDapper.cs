...
/// <summary>
/// Dapper implementation of <see cref="IBreachAuditStore"/> for SQL Server.
...
public sealed class BreachAuditStoreDapper : IBreachAuditStore
{
    ...
    /// <summary>
    /// Maps a dynamic Dapper row to a <see cref="BreachAuditEntryEntity"/>.
    /// Uses direct casting for SQL Server native types (DateTimeOffset).
    /// </summary>
    /// <param name="row">The dynamic row from Dapper query.</param>
    /// <returns>A populated breach audit entry entity.</returns>
