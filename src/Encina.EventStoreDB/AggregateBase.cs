...
public abstract class AggregateBase : IAggregate
{
    ...
    /// <summary>
    /// Applies an event from history to rebuild the aggregate state.
    /// </summary>
    /// <param name="domainEvent">The historical event to apply.</param>
    /// <param name="version">The version number of this event.</param>
    internal void ApplyFromHistory(object domainEvent, long version)
    {
        Apply(domainEvent);
        Version = version;
    }
