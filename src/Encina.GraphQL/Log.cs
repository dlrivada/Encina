...
internal static partial class Log
{
    ...
    [LoggerMessage(EventId = 4552, Level = LogLevel.Warning, Message = "GraphQL query of type {QueryType} failed: {ErrorMessage}")]
    ...
    [LoggerMessage(EventId = 4556, Level = LogLevel.Warning, Message = "GraphQL mutation of type {MutationType} failed: {ErrorMessage}")]
