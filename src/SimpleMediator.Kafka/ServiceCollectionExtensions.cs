...
/// <summary>
/// Extension methods for configuring SimpleMediator Kafka integration.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds SimpleMediator Kafka integration services.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <param name="configure">Optional configuration action.</param>
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddSimpleMediatorKafka(
        this IServiceCollection services,
        Action<SimpleMediatorKafkaOptions>? configure = null)
    {
        ArgumentNullException.ThrowIfNull(services);

        var options = new SimpleMediatorKafkaOptions();
        configure?.Invoke(options);

        services.Configure<SimpleMediatorKafkaOptions>(opt =>
        {
