...
/// <summary>
/// SQL Server implementation of <see cref="IBulkOperations{TEntity}"/> using SqlBulkCopy
...
/// </list>
/// </remarks>
public sealed class BulkOperationsEFSqlServer<TEntity> : IBulkOperations<TEntity>
    where TEntity : class, new()
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="BulkOperationsEFSqlServer{TEntity}"/> class.
    /// </summary>
    /// <param name="dbContext">The database context.</param>
    public BulkOperationsEFSqlServer(DbContext dbContext)
    {
