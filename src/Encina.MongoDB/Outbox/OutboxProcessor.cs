...
/// Each cycle resolves the scoped <see cref="IOutboxStore"/> registered by
/// <see cref="ServiceCollectionExtensions.AddEncinaMongoDB(Microsoft.Extensions.DependencyInjection.IServiceCollection, System.Action{EncinaMongoDbOptions})"/>
/// (an <see cref="OutboxStoreMongoDB"/>) through the base class's default resolution.
/// </remarks>
