...
///   <item>
///     <description>
///       <see cref="ICommand{TResponse}"/>: Routes to primary (<see cref="DatabaseIntent.Write"/>)
///     </description>
///   </item>
///   <item>
///     <description>
///       <see cref="IQuery{TResponse}"/>: Routes to secondary (<see cref="DatabaseIntent.Read"/>)
///     </description>
///   </item>
///   <item>
///     <description>
///       <see cref="IQuery{TResponse}"/> with <see cref="ForceWriteDatabaseAttribute"/>:
///       Routes to primary (<see cref="DatabaseIntent.ForceWrite"/>)
///     </description>
///   </item>
/// </list>
/// </para>
...
/// <example>
/// <code>
/// // Query automatically routes to secondary (SecondaryPreferred by default)
/// public sealed record GetProductsQuery : IQuery&lt;IReadOnlyList&lt;Product&gt;&gt;;
///
/// // Command automatically routes to primary
