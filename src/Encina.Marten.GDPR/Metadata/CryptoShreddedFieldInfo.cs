...
/// <summary>
/// Captures metadata about a property decorated with <see cref="CryptoShreddedAttribute"/>,
...
/// </para>
/// </remarks>
internal sealed class CryptoShreddedFieldInfo
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CryptoShreddedFieldInfo"/> class.
    /// </summary>
    ...
    /// <summary>
    /// The <see cref="CryptoShreddedAttribute"/> applied to this property.
    /// </summary>
    internal CryptoShreddedAttribute Attribute { get; }
    ...
    /// <summary>
    /// The name of the sibling property that identifies the data subject.
    /// </summary>
    /// <remarks>
    /// Corresponds to <see cref="CryptoShreddedAttribute.SubjectIdProperty"/>.
