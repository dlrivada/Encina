...
{
    [LoggerMessage(EventId = 4350, Level = LogLevel.Debug, Message = "Sending message of type {MessageType} to queue {Queue}")]
    public static partial void SendingToQueue(ILogger logger, string messageType, string queue);

    [LoggerMessage(EventId = 4351, Level = LogLevel.Debug, Message = "Successfully sent message of type {MessageType} with ID {MessageId}")]
    public static partial void SuccessfullySentMessage(ILogger logger, string messageType, string messageId);

    [LoggerMessage(EventId = 4352, Level = LogLevel.Error, Message = "Failed to send message of type {MessageType} to queue {Queue}")]
    public static partial void FailedToSendToQueue(ILogger logger, Exception exception, string messageType, string queue);

    [LoggerMessage(EventId = 4353, Level = LogLevel.Debug, Message = "Publishing message of type {MessageType} to topic {Topic}")]
    public static partial void PublishingToTopic(ILogger logger, string messageType, string topic);

    [LoggerMessage(EventId = 4354, Level = LogLevel.Debug, Message = "Successfully published message of type {MessageType} with ID {MessageId}")]
    public static partial void SuccessfullyPublishedMessage(ILogger logger, string messageType, string messageId);

    [LoggerMessage(EventId = 4355, Level = LogLevel.Error, Message = "Failed to publish message of type {MessageType} to topic {Topic}")]
    public static partial void FailedToPublishToTopic(ILogger logger, Exception exception, string messageType, string topic);

    [LoggerMessage(EventId = 4356, Level = LogLevel.Debug, Message = "Sending batch of {Count} messages of type {MessageType}")]
    public static partial void SendingBatch(ILogger logger, int count, string messageType);

    [LoggerMessage(EventId = 4357, Level = LogLevel.Warning, Message = "Batch send partially failed: {FailedCount} of {TotalCount} messages failed")]
    public static partial void BatchPartiallyFailed(ILogger logger, int failedCount, int totalCount);

    [LoggerMessage(EventId = 4358, Level = LogLevel.Debug, Message = "Successfully sent {Count} messages")]
    public static partial void SuccessfullySentBatch(ILogger logger, int count);

    [LoggerMessage(EventId = 4359, Level = LogLevel.Error, Message = "Failed to send batch of messages of type {MessageType}")]
    public static partial void FailedToSendBatch(ILogger logger, Exception exception, string messageType);

    [LoggerMessage(EventId = 4360, Level = LogLevel.Debug, Message = "Sending FIFO message of type {MessageType} to queue {Queue} with group {Group}")]
    public static partial void SendingFifoMessage(ILogger logger, string messageType, string queue, string group);

    [LoggerMessage(EventId = 4361, Level = LogLevel.Debug, Message = "Successfully sent FIFO message with ID {MessageId}")]
