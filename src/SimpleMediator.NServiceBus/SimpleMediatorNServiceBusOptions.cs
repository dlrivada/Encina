...
/// <summary>
/// Configuration options for SimpleMediator NServiceBus integration.
/// </summary>
public sealed class SimpleMediatorNServiceBusOptions
{
    /// <summary>
    /// Gets or sets the endpoint name for NServiceBus.
    /// </summary>
    public string EndpointName { get; set; } = "SimpleMediator.Endpoint";
