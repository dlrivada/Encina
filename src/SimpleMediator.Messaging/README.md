# SimpleMediator.Messaging

[![NuGet](https://img.shields.io/nuget/v/SimpleMediator.Messaging.svg)](https://www.nuget.org/packages/SimpleMediator.Messaging/)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](../../LICENSE)

**Provider-agnostic abstractions for distributed messaging patterns in SimpleMediator.**
...
SimpleMediator.Messaging follows a **pay-for-what-you-use** philosophy. If your application is a simple CRUD app, you might only use transactions. If you're building a complex distributed system, you can enable all patterns.
...
|----------|---------|----------|
| **Entity Framework Core** | `SimpleMediator.EntityFrameworkCore` | Full ORM, change tracking, migrations |
| **Dapper** | `SimpleMediator.Dapper` | Lightweight, SQL control, performance |
| **ADO.NET** | `SimpleMediator.Data` | Maximum performance, full control |
...
services.AddSimpleMediatorOutbox<AppDbContext>();  // EF Core
services.AddSimpleMediatorOutbox(dapperConnection); // Dapper
services.AddSimpleMediatorOutbox(adoConnection);    // ADO.NET
```
...
| Feature | SimpleMediator.Scheduling | Hangfire | Quartz.NET |
|---------|--------------------------|----------|------------|
...
```csharp
// SimpleMediator.Scheduling for domain messages
await _scheduler.ScheduleAsync(
...
services.AddSimpleMediatorScheduling()
    .UseHangfire();
...
```csharp
services.AddSimpleMediatorEntityFrameworkCore<AppDbContext>()
    .AddTransactions()
    .AddOutbox(options =>
    {
