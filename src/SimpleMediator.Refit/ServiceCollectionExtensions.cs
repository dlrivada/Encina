...
namespace SimpleMediator.Refit;

/// <summary>
/// Extension methods for configuring SimpleMediator with Refit.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Adds a Refit client and registers the corresponding handler for SimpleMediator requests.
    /// </summary>
    ...
    /// <remarks>
    /// This method combines Refit's AddRefitClient with SimpleMediator handler registration.
    ...
    /// </code>
    /// </example>
    public static IHttpClientBuilder AddSimpleMediatorRefitClient<TApiClient>(
        ...
        where TApiClient : class
    {
        ...
        // Note: The handler is registered automatically by SimpleMediator's assembly scanning
        // when you call AddSimpleMediator() because it implements IRequestHandler<,>
    ...
    /// };
    ///
    /// services.AddSimpleMediatorRefitClient&lt;IGitHubApi&gt;(
    ///     refitSettings,
