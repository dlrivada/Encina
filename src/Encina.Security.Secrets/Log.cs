...
internal static partial class Log
{
    ...
    [LoggerMessage(EventId = 8952, Level = LogLevel.Debug, Message = "Secret '{SecretName}' stored in cache")]
    public static partial void CacheSet(ILogger logger, string secretName);
