...
/// <summary>
/// Translates <see cref="Specification{T}"/> expressions to SQL clauses with Dapper parameters for Oracle.
/// </summary>
...
/// <item><description>Uses FROM DUAL for queries without tables</description></item>
/// </list>
/// </para>
/// <para>
    ...
    where TEntity : class
{
        ...
        Dictionary<string, object?> parameters)
    {
        ...
        return $"\"{columnName}\" > :p{_parameterIndex - 1}";
    }
