-- =============================================
-- Encina.Dapper.Oracle - Complete Database Schema
...
BEGIN
    ...
    DBMS_OUTPUT.PUT_LINE('Encina.Dapper.Oracle schema installation complete!');
    DBMS_OUTPUT.PUT_LINE('You can now use all messaging patterns with Dapper.');
EXCEPTION
    WHEN OTHERS THEN
