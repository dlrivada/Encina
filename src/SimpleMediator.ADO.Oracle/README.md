...
SimpleMediator.ADO implements messaging patterns (Outbox, Inbox, Transactions) using raw ADO.NET with OracleCommand and OracleDataReader, offering the lightest possible overhead and full SQL transparency.
