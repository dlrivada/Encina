...
/// <summary>
/// ADO.NET implementation of <see cref="IAuditStore"/> for MySQL/MariaDB.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class AuditStoreADO : IAuditStore
{
    ...
    private static AuditEntry MapToEntry(IDataReader reader) => new()
    {
        ...
        StartedAtUtc = new DateTimeOffset(reader.GetDateTime(reader.GetOrdinal("StartedAtUtc")), TimeSpan.Zero),
        CompletedAtUtc = new DateTimeOffset(reader.GetDateTime(reader.GetOrdinal("CompletedAtUtc")), TimeSpan.Zero),
