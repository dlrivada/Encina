...
/// <summary>
/// Soft-delete-aware SQL builder for ADO.NET with MySQL that automatically prepends soft delete filters to queries.
/// </summary>
...
/// <item>Boolean values as 0/1</item>
    ...
    where TEntity : class
{
    ...
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
    /// <returns>The pagination clause (LIMIT/OFFSET for MySQL).</returns>
        ...
        Action<IDbCommand> existingAddParameters)
    {
        ...
        // MySQL uses 0/1 for boolean values
