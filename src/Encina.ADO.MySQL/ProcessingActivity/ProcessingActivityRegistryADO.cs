...
namespace Encina.ADO.MySQL.ProcessingActivity;

/// <summary>
/// ADO.NET implementation of <see cref="IProcessingActivityRegistry"/> for MySQL/MariaDB.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Register via <c>AddEncinaProcessingActivityADOMySQL(connectionString)</c>.
/// </para>
/// </remarks>
public sealed class ProcessingActivityRegistryADO : IProcessingActivityRegistry
{
    ...
    private static void AddActivityParameters(MySqlCommand command, ProcessingActivityEntity entity)
    {
    ...
    private static ProcessingActivityEntity MapToEntity(MySqlDataReader reader) => new()
    {
