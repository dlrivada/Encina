...
/// <summary>
/// ADO.NET implementation of <see cref="IResidencyPolicyStore"/> for MySQL.
/// Provides CRUD operations for residency policies per GDPR Article 44.
/// </summary>
/// <remarks>
/// <para>
/// Each policy defines which regions are allowed for a specific data category,
/// whether adequacy decisions are required, and which transfer legal bases are
/// permitted for cross-border transfers.
/// </para>
/// <para>
/// Uses <see cref="MySqlConnector"/> for native async MySQL operations and
/// <see cref="ResidencyPolicyMapper"/> for domain-entity type transformations.
/// Boolean values are stored as integers (0/1) for MySQL compatibility.
/// </para>
/// </remarks>
public sealed class ResidencyPolicyStoreADO : IResidencyPolicyStore
{
    ...
    private static ResidencyPolicyEntity MapToEntity(IDataReader reader)
    {
        ...
        return new ResidencyPolicyEntity
        {
            ...
            RequireAdequacyDecision = reader.GetInt32(reader.GetOrdinal("RequireAdequacyDecision")) != 0,
