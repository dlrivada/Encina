...
namespace Encina.ADO.MySQL.Pagination;

/// <summary>
/// Helper class for executing cursor-paginated queries using ADO.NET with MySQL.
/// </summary>
/// <remarks>
/// <para>
    ...
    where TEntity : class
{
        ...
        string? columns)
    {
        ...
        // MySQL uses LIMIT at the end and backticks for identifiers
