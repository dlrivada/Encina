...
internal static partial class Log
{
    ...
    [LoggerMessage(EventId = 4053, Level = LogLevel.Error, Message = "Quartz job {JobKey} failed for request {RequestType} with error code {ErrorCode} ({Classification})")]
    public static partial void RequestJobFailed(ILogger logger, JobKey jobKey, string requestType, string errorCode, string classification);
    ...
    [LoggerMessage(EventId = 4059, Level = LogLevel.Error, Message = "Quartz notification job {JobKey} failed for {NotificationType} with error code {ErrorCode} ({Classification})")]
    public static partial void NotificationJobFailed(ILogger logger, JobKey jobKey, string notificationType, string errorCode, string classification);
