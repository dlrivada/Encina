...
Entity Framework Core implementation for SimpleMediator messaging patterns including Outbox, Inbox, Saga orchestration, and Scheduled messages.
...
```bash
dotnet add package SimpleMediator.EntityFrameworkCore
```
...
builder.Services.AddSimpleMediatorEntityFrameworkCore<AppDbContext>(config =>
{
...
- **SimpleMediator.AspNetCore**: ASP.NET Core integration with endpoint filters and middleware
