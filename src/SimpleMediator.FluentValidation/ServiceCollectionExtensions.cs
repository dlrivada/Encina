...
namespace SimpleMediator.FluentValidation;

/// <summary>
/// Extension methods for configuring FluentValidation integration with SimpleMediator.
/// </summary>
public static class ServiceCollectionExtensions
{
    ...
    public static IServiceCollection AddSimpleMediatorFluentValidation(
