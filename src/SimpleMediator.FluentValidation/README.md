...
[![NuGet](https://img.shields.io/nuget/v/SimpleMediator.FluentValidation.svg)](https://www.nuget.org/packages/SimpleMediator.FluentValidation)
...
FluentValidation integration for SimpleMediator with Railway Oriented Programming (ROP) support.
...
```bash
dotnet add package SimpleMediator.FluentValidation
```
...
// Register SimpleMediator with FluentValidation
...
services.AddSimpleMediatorFluentValidation(
...
- **Don't register validators manually** - use `AddSimpleMediatorFluentValidation`
...
- **SimpleMediator.OpenTelemetry** - Distributed tracing (coming soon)
