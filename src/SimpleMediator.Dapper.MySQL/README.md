...
MySQL/MariaDB implementation of SimpleMediator messaging patterns using Dapper, including Outbox, Inbox, Saga orchestration, and Scheduled messages.
...
```bash
dotnet add package SimpleMediator.Dapper.MySQL
```
