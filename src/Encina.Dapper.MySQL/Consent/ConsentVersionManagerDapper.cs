...
/// <summary>
/// Dapper implementation of <see cref="IConsentVersionManager"/> for MySQL.
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            return Right(new ConsentVersion
            {
                ...
                RequiresExplicitReconsent = Convert.ToBoolean(row.RequiresExplicitReconsent)
            });
        }
        catch (Exception ex)
        {
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var consentedVersionId = await _connection.QueryFirstOrDefaultAsync<string?>(
                consentSql,
                new { SubjectId = subjectId, Purpose = purpose, ActiveStatus = (int)ConsentStatus.Active });
            ...
            var requiresReconsent = Convert.ToBoolean(row.RequiresExplicitReconsent);
