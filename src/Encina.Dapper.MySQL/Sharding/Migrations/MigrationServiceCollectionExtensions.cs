using Encina.ADO.MySQL.Sharding.Migrations;
using Encina.Sharding.Migrations;
using Microsoft.Extensions.DependencyInjection;
using Microsoft.Extensions.DependencyInjection.Extensions;

namespace Encina.Dapper.MySQL.Sharding.Migrations;

/// <summary>
/// Extension methods for registering Encina Dapper MySQL shard migration services.
/// </summary>
/// <remarks>
/// <para>
/// Dapper delegates migration infrastructure to the ADO.NET MySQL provider since both
...
{
    /// <summary>
    /// Adds Encina shard migration services for Dapper with MySQL.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection for chaining.</returns>
    /// <remarks>
    /// <para>
    /// Registers the following services using the ADO.NET MySQL implementations:
    /// <list type="bullet">
