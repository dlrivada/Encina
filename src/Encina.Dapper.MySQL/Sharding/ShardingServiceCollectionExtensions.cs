...
using Encina.Dapper.MySQL.Sharding.ReferenceTables;
...
/// <summary>
/// Extension methods for configuring Encina Dapper MySQL sharding services.
/// </summary>
public static class ShardingServiceCollectionExtensions
{
    /// <summary>
    /// Adds Encina sharded repository for a specific entity type using Dapper with MySQL.
    /// </summary>
    ...
    /// <item><see cref="IFunctionalShardedRepository{TEntity, TId}"/> with MySQL Dapper implementation</item>
    /// </list>
    /// </para>
    /// </remarks>
    /// <example>
    ...
    /// <summary>
    /// Adds Encina sharded read/write connection factory using Dapper with MySQL.
    /// </summary>
    /// <param name="services">The service collection.</param>
    ...
    /// <summary>
    /// Registers the Dapper MySQL reference table store factory for shard-based replication.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection for chaining.</returns>
