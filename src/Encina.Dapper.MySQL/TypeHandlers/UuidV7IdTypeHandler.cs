...
/// <summary>
/// Dapper type handler for <see cref="UuidV7Id"/> values in MySQL.
/// MySQL stores UUIDv7 values as CHAR(36), so this handler converts between <see cref="UuidV7Id"/> and <see cref="string"/>.
/// </summary>
