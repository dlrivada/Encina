...
/// <summary>
/// Dapper implementation of <see cref="ILawfulBasisRegistry"/> for MySQL/MariaDB.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class LawfulBasisRegistryDapper : ILawfulBasisRegistry
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            const string sql = """
                INSERT INTO `LawfulBasisRegistrations` (`Id`, `RequestTypeName`, `BasisValue`, `Purpose`, `LIAReference`, `LegalReference`, `ContractReference`, `RegisteredAtUtc`)
