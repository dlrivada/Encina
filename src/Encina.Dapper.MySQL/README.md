...
```bash
# In your database
mysql -S localhost -d YourDatabase -i Scripts/001_CreateOutboxMessagesTable.sql
mysql -S localhost -d YourDatabase -i Scripts/002_CreateInboxMessagesTable.sql
mysql -S localhost -d YourDatabase -i Scripts/003_CreateSagaStatesTable.sql
mysql -S localhost -d YourDatabase -i Scripts/004_CreateScheduledMessagesTable.sql
```
...
3. **SQL Scripts Required**: No automatic migrations
   ...
   mysql -i Scripts/000_CreateAllTables.sql
   ```
