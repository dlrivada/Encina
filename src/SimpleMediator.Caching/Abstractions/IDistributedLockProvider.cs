...
/// <item><description>Garnet - Native lock support</description></item>
/// <item><description>Database locks (EF Core, ADO.NET) - For transactional consistency</description></item>
/// <item><description>Memory - Local process locking (single instance only)</description></item>
/// </list>
/// </remarks>
/// <example>
/// <code>
...
///         if (@lock is null)
///         {
///             throw new ConcurrencyException($"Could not acquire lock for order {orderId}");
///         }
///
