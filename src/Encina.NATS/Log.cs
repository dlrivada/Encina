...
{
    [LoggerMessage(EventId = 4200, Level = LogLevel.Debug, Message = "Publishing message of type {MessageType} to subject {Subject}")]
    public static partial void PublishingMessage(ILogger logger, string messageType, string subject);

    [LoggerMessage(EventId = 4201, Level = LogLevel.Debug, Message = "Successfully published message to subject {Subject}")]
    public static partial void SuccessfullyPublishedMessage(ILogger logger, string subject);

    [LoggerMessage(EventId = 4202, Level = LogLevel.Error, Message = "Failed to publish message of type {MessageType} to subject {Subject}")]
    public static partial void FailedToPublishMessage(ILogger logger, Exception exception, string messageType, string subject);

    [LoggerMessage(EventId = 4203, Level = LogLevel.Debug, Message = "Sending request of type {RequestType} to subject {Subject}")]
    public static partial void SendingRequest(ILogger logger, string requestType, string subject);

    [LoggerMessage(EventId = 4204, Level = LogLevel.Debug, Message = "Successfully received response for request of type {RequestType}")]
    public static partial void SuccessfullyReceivedResponse(ILogger logger, string requestType);

    [LoggerMessage(EventId = 4205, Level = LogLevel.Error, Message = "Failed to send request of type {RequestType}")]
    public static partial void FailedToSendRequest(ILogger logger, Exception exception, string requestType);

    [LoggerMessage(EventId = 4206, Level = LogLevel.Debug, Message = "Publishing message of type {MessageType} to JetStream subject {Subject}")]
    public static partial void PublishingToJetStream(ILogger logger, string messageType, string subject);

    [LoggerMessage(EventId = 4207, Level = LogLevel.Debug, Message = "Successfully published message to stream {Stream} with sequence {Sequence}")]
