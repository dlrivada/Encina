...
/// </para>
/// <para>
/// Use <see cref="EntityMappingBuilder{TEntity, TId}"/> for fluent configuration
/// of entity mappings.
/// </para>
/// </remarks>
/// <example>
    ...
    where TId : notnull
{
    ...
    /// </summary>
    /// <remarks>
    /// The table name should be a valid SQL identifier. It can include
    /// schema prefixes like "dbo.Orders" or bracket-delimited names like "[Orders]".
    /// </remarks>
