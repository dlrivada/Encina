...
namespace Encina.ADO.SqlServer.Repository;

/// <summary>
/// Translates <see cref="Specification{T}"/> expressions to SQL clauses with ADO.NET parameters.
/// </summary>
    ...
    where TEntity : class
{
    ...
    public string GetColumnNameFromSelector<TValue>(Expression<Func<TEntity, TValue>> selector)
    {
        ...
        // Handle Convert for value types (e.g., boxing)
