...
/// <summary>
/// ADO.NET implementation of <see cref="IReadAuditStore"/> for SQL Server.
/// </summary>
/// <remarks>
/// <para>
...
/// <item><description>UNIQUEIDENTIFIER for native GUID storage</description></item>
/// <item><description>DATETIMEOFFSET for timestamps with timezone information</description></item>
/// <item><description>INT for enum storage (AccessMethod ordinal)</description></item>
...
public sealed class ReadAuditStoreADO : IReadAuditStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            AddParameter(command, "@AccessedAtUtc", entity.AccessedAtUtc);
    ...
    private static ReadAuditEntry MapToEntry(IDataReader reader)
    {
        var entity = new ReadAuditEntryEntity
        {
            ...
            // SQL Server supports native DateTimeOffset via SqlDataReader
            AccessedAtUtc = GetDateTimeOffset(reader, reader.GetOrdinal("AccessedAtUtc")),
