...
/// <summary>
/// Extension methods for configuring Encina ADO.NET with multi-tenancy support.
/// </summary>
public static class TenancyServiceCollectionExtensions
{
    /// <summary>
    /// Adds Encina messaging patterns with ADO.NET persistence and multi-tenancy support.
    /// </summary>
    ...
    /// <remarks>
    /// <para>
    /// This method registers all necessary services for multi-tenant ADO.NET operations:
    /// </para>
    /// <list type="bullet">
    ...
    /// </code>
    /// </example>
    public static IServiceCollection AddEncinaADOWithTenancy(
    ...
    /// <summary>
    /// Registers a tenant-aware functional repository for an entity type using ADO.NET.
    /// </summary>
    ...
    /// <item><see cref="ADOTenancyOptions"/> to be registered (via <see cref="AddEncinaADOWithTenancy"/>)</item>
    /// </list>
    /// </para>
    /// </remarks>
    /// <example>
    ...
    /// <summary>
    /// Registers a read-only tenant-aware repository for an entity type using ADO.NET.
    /// </summary>
    /// <typeparam name="TEntity">The entity type.</typeparam>
    /// <typeparam name="TId">The entity identifier type.</typeparam>
    /// <param name="services">The service collection.</param>
