...
namespace Encina.ADO.SqlServer.ProcessingActivity;

/// <summary>
/// ADO.NET implementation of <see cref="IProcessingActivityRegistry"/> for SQL Server.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// <para>
/// Register via <c>AddEncinaProcessingActivityADOSqlServer(connectionString)</c>.
/// </para>
/// </remarks>
public sealed class ProcessingActivityRegistryADO : IProcessingActivityRegistry
{
    ...
    private static void AddActivityParameters(SqlCommand command, ProcessingActivityEntity entity)
    {
    ...
    private static ProcessingActivityEntity MapToEntity(SqlDataReader reader) => new()
    {
