...
/// <summary>
/// ADO.NET implementation of <see cref="ILawfulBasisRegistry"/> for SQL Server.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class LawfulBasisRegistryADO : ILawfulBasisRegistry
{
    ...
    private static void AddRegistrationParameters(SqlCommand command, LawfulBasisRegistrationEntity entity)
    {
    ...
    private static LawfulBasisRegistrationEntity MapToEntity(SqlDataReader reader) => new()
    {
        ...
        RegisteredAtUtc = (DateTimeOffset)reader.GetValue(reader.GetOrdinal("RegisteredAtUtc"))
    };
}
