...
public sealed record LawfulBasisValidationResult
{
    ...
    /// </summary>
    public GDPR.LawfulBasis? Basis { get; }
    ...
    public static LawfulBasisValidationResult Valid(GDPR.LawfulBasis basis) =>
        new(true, basis, [], []);
    ...
    public static LawfulBasisValidationResult ValidWithWarnings(GDPR.LawfulBasis basis, params string[] warnings) =>
    ...
    public static LawfulBasisValidationResult Invalid(GDPR.LawfulBasis basis, IReadOnlyList<string> errors, IReadOnlyList<string> warnings) =>
