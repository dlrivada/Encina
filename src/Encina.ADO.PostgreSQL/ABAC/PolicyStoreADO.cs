...
namespace Encina.ADO.PostgreSQL.ABAC;

/// <summary>
/// PostgreSQL ADO.NET implementation of <see cref="IPolicyStore"/> for persistent ABAC policy storage.
/// Uses raw <see cref="NpgsqlCommand"/> and <see cref="NpgsqlDataReader"/> for maximum performance.
/// </summary>
/// <remarks>
/// <para>
