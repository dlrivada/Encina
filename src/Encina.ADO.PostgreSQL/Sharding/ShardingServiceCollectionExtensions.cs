...
public static class ShardingServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Adds Encina sharded read/write connection factory using ADO.NET with PostgreSQL.
    /// </summary>
    /// <param name="services">The service collection.</param>
    ...
    /// <see cref="IShardedReadWriteConnectionFactory{TConnection}"/> for <see cref="NpgsqlConnection"/></item>
