...
namespace Encina.ADO.PostgreSQL.Modules;

/// <summary>
/// A database command wrapper that validates SQL statements against module schema boundaries for PostgreSQL.
/// </summary>
/// <remarks>
/// <para>
...
/// <see cref="SchemaValidatingConnection"/> to enforce module isolation at the ADO.NET level.
/// </para>
/// <para>
