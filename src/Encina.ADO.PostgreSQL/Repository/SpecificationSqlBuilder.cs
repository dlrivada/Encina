...
/// <summary>
/// Translates <see cref="Specification{T}"/> expressions to SQL clauses with ADO.NET parameters for PostgreSQL.
/// </summary>
...
/// <item><description>Pagination uses LIMIT/OFFSET</description></item>
/// <item><description>Native UUID (GUID) support</description></item>
/// <item><description>Uses @param style parameters (Npgsql supports both $ and @ prefixes)</description></item>
/// </list>
/// </para>
/// <para>
    ...
    where TEntity : class
{
    ...
    /// <summary>
    /// Builds pagination SQL (LIMIT/OFFSET for PostgreSQL).
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
    ...
    public string BuildPaginationClause(IQuerySpecification<TEntity> specification)
    {
        ...
        // PostgreSQL allows OFFSET without LIMIT using OFFSET with LIMIT ALL
        return skip > 0 ? $"LIMIT ALL OFFSET {skip}" : string.Empty;
    }
