...
public static class ServiceCollectionExtensions
{
    ...
    /// <summary>
    /// Adds persistent GDPR processing activity registry using ADO.NET for PostgreSQL.
    /// </summary>
    /// <remarks>
    /// <para>
    /// Registers <see cref="IProcessingActivityRegistry"/> as a singleton backed by a PostgreSQL
    ...
    /// <param name="connectionString">The PostgreSQL connection string.</param>
    /// <returns>The service collection for chaining.</returns>
    public static IServiceCollection AddEncinaProcessingActivityADOPostgreSQL(
        this IServiceCollection services,
        string connectionString)
    {
        ArgumentNullException.ThrowIfNull(services);
