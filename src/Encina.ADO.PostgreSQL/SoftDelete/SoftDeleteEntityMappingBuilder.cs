...
namespace Encina.ADO.PostgreSQL.SoftDelete;

/// <summary>
/// Fluent builder for configuring soft-delete-aware entity-to-table mappings.
/// </summary>
    ...
    where TId : notnull
{
    ...
    /// <remarks>
    /// <para>
    /// The <c>IsDeleted</c> property must be of type <see cref="bool"/>.
    /// This method also adds the property to the column mappings and excludes
    /// it from INSERT operations (defaults to <c>false</c>).
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// The <c>DeletedAtUtc</c> property must be of type <see cref="DateTime"/>? (nullable).
    /// This property is automatically set when an entity is soft-deleted.
    /// </para>
    /// </remarks>
    ...
    /// <remarks>
    /// <para>
    /// The <c>DeletedBy</c> property must be of type <see cref="string"/>? (nullable).
    /// This property is automatically set when an entity is soft-deleted.
    /// </para>
    /// </remarks>
...
/// <summary>
/// Internal implementation of <see cref="ISoftDeleteEntityMapping{TEntity, TId}"/>.
/// </summary>
