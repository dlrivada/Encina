...
/// <summary>
/// Soft-delete-aware SQL builder for ADO.NET with PostgreSQL that automatically prepends soft delete filters to queries.
/// </summary>
/// <typeparam name="TEntity">The entity type.</typeparam>
/// <remarks>
/// <para>
/// This builder extends <see cref="SpecificationSqlBuilder{TEntity}"/> functionality
/// to automatically add <c>WHERE "IsDeleted" = false</c> to all queries when
...
/// <item>Native boolean support (true/false literals)</item>
    ...
    where TEntity : class
{
    ...
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
    /// <returns>The pagination clause (LIMIT/OFFSET for PostgreSQL).</returns>
        ...
        Action<IDbCommand> existingAddParameters)
    {
        ...
        var softDeleteFilter = $"\"{_mapping.IsDeletedColumnName}\" = false";
