...
namespace Encina.ADO.Sqlite.Pagination;

/// <summary>
/// Helper class for executing cursor-paginated queries using ADO.NET with SQLite.
/// </summary>
/// <remarks>
/// <para>
    ...
    where TEntity : class
{
        ...
        string? columns)
    {
        ...
        // SQLite uses LIMIT at the end and double-quotes for identifiers
