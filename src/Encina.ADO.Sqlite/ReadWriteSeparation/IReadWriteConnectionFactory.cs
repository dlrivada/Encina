...
///     {
///         await using var connection = await _connectionFactory.CreateReadConnectionAsync(ct);
...
///     {
///         await using var connection = await _connectionFactory.CreateWriteConnectionAsync(ct);
///         using var command = connection.CreateCommand();
