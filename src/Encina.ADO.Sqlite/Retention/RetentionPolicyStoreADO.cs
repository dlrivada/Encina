...
/// <summary>
/// ADO.NET implementation of <see cref="IRetentionPolicyStore"/> for SQLite.
...
public sealed class RetentionPolicyStoreADO : IRetentionPolicyStore
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            AddParameter(command, "@AutoDelete", entity.AutoDelete ? 1 : 0);
    ...
    private static RetentionPolicyEntity MapToEntity(IDataReader reader)
    {
        ...
        return new RetentionPolicyEntity
        {
            ...
            AutoDelete = reader.GetInt32(reader.GetOrdinal("AutoDelete")) != 0,
