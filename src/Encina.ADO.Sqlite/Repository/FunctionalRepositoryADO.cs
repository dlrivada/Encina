...
/// with Railway Oriented Programming error handling for SQLite.
/// </summary>
...
/// <list type="bullet">
/// <item><description>Uses LIMIT/OFFSET for pagination (not OFFSET/FETCH)</description></item>
    ...
    where TId : notnull
{
    ...
    private static object? ConvertValue(object value, Type targetType)
    {
        ...
        // Handle GUID conversion from SQLite TEXT
    ...
    private void AddEntityParameters(IDbCommand command, TEntity entity, bool forInsert)
    {
        ...
        foreach (var (propertyName, _) in _mapping.ColumnMappings)
        {
            ...
            if (_propertyCache.TryGetValue(propertyName, out var property))
            {
                ...
                // Convert GUID to string for SQLite storage
