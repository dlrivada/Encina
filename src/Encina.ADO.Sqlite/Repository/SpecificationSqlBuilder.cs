...
/// <summary>
/// Translates <see cref="Specification{T}"/> expressions to SQL clauses with ADO.NET parameters for SQLite.
/// </summary>
...
/// <item><description>Pagination uses LIMIT/OFFSET instead of OFFSET/FETCH</description></item>
/// <item><description>No schema support (SQLite has no schemas)</description></item>
/// </list>
/// </para>
/// <para>
    ...
    where TEntity : class
{
    ...
    /// <summary>
    /// Builds pagination SQL (LIMIT/OFFSET for SQLite).
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
    /// <returns>The pagination clause.</returns>
    /// <remarks>
    /// SQLite uses LIMIT/OFFSET syntax instead of OFFSET/FETCH.
    /// </remarks>
