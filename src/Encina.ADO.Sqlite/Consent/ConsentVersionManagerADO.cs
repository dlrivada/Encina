...
/// <summary>
/// ADO.NET implementation of <see cref="IConsentVersionManager"/> for SQLite.
...
public sealed class ConsentVersionManagerADO : IConsentVersionManager
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            AddParameter(insertCommand, "@EffectiveFromUtc", version.EffectiveFromUtc.ToString("O"));
            AddParameter(insertCommand, "@Description", version.Description);
            AddParameter(insertCommand, "@RequiresExplicitReconsent", version.RequiresExplicitReconsent ? 1 : 0);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var requiresReconsent = versionReader.GetInt32(versionReader.GetOrdinal("RequiresExplicitReconsent")) != 0;
    ...
    private static ConsentVersion MapToConsentVersion(IDataReader reader) => new()
    {
        ...
        EffectiveFromUtc = DateTimeOffset.Parse(reader.GetString(reader.GetOrdinal("EffectiveFromUtc")), null, DateTimeStyles.RoundtripKind),
        Description = reader.GetString(reader.GetOrdinal("Description")),
        RequiresExplicitReconsent = reader.GetInt32(reader.GetOrdinal("RequiresExplicitReconsent")) != 0
    };
