...
/// <summary>
/// Database health monitor for SQLite using ADO.NET.
/// </summary>
/// <remarks>
/// <para>
...
/// </para>
/// </remarks>
public sealed class SqliteDatabaseHealthMonitor : DatabaseHealthMonitorBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SqliteDatabaseHealthMonitor"/> class.
    /// </summary>
    ...
    public SqliteDatabaseHealthMonitor(
        IServiceProvider serviceProvider,
        DatabaseResilienceOptions? options = null)
        : base("ado-sqlite", CreateConnectionFactory(serviceProvider), options)
    {
    }
