...
/// <summary>
/// Tenant-aware SQL builder that automatically prepends tenant filters to queries for ADO.NET Oracle.
/// </summary>
    ...
    where TEntity : class
{
    ...
    /// </summary>
    /// <param name="specification">The query specification to translate.</param>
    /// <returns>The pagination clause (OFFSET/FETCH for Oracle 12c+).</returns>
        ...
        Action<IDbCommand> existingAddParameters)
    {
        ...
        {
            // Add tenant parameter (Oracle uses colon prefix)
