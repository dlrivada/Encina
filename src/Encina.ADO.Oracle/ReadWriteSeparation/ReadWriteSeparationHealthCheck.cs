...
public sealed class ReadWriteSeparationHealthCheck : EncinaHealthCheck
{
    ...
    /// </summary>
    public const string DefaultName = "encina-read-write-separation-ado-oracle";
    ...
    public ReadWriteSeparationHealthCheck(ReadWriteSeparationOptions options)
        : base(
            DefaultName,
            new System.Collections.Generic.HashSet<string> { "encina", "database", "read-write-separation", "ado", "oracle", "ready" })
    {
