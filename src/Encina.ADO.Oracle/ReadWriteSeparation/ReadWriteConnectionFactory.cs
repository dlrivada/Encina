...
namespace Encina.ADO.Oracle.ReadWriteSeparation;

/// <summary>
/// Oracle implementation of <see cref="IReadWriteConnectionFactory"/> that routes
/// connections to the primary database or read replicas based on routing context.
/// </summary>
/// <remarks>
/// <para>
/// This factory creates <see cref="OracleConnection"/> instances configured for either
...
///     config.ReadWriteSeparationOptions.WriteConnectionString = "Data Source=primary;...";
///     config.ReadWriteSeparationOptions.ReadConnectionStrings.Add("Data Source=replica;...");
/// });
///
/// // Usage
...
public sealed class ReadWriteConnectionFactory : IReadWriteConnectionFactory
{
    ...
    public async ValueTask<IDbConnection> CreateWriteConnectionAsync(CancellationToken cancellationToken = default)
    {
        ...
        var connection = (OracleConnection)CreateWriteConnection();
    ...
    public async ValueTask<IDbConnection> CreateReadConnectionAsync(CancellationToken cancellationToken = default)
    {
        ...
        var connection = (OracleConnection)CreateReadConnection();
        await connection.OpenAsync(cancellationToken).ConfigureAwait(false);
        return connection;
    }
