...
/// <summary>
/// Extension methods for configuring Encina Dapper with multi-tenancy support for PostgreSQL.
/// </summary>
public static class TenancyServiceCollectionExtensions
{
    /// <summary>
    /// Adds Encina messaging patterns with Dapper persistence and multi-tenancy support.
    /// </summary>
    ...
    /// <summary>
    /// Registers a tenant-aware functional repository for an entity type using Dapper.
    /// </summary>
    ...
    /// </para>
    /// <para>
    /// <b>PostgreSQL-specific:</b> Uses double-quoted identifiers for table and column names.
    /// </para>
    /// </remarks>
    /// <example>
    /// <code>
    ...
    /// <summary>
    /// Registers a read-only tenant-aware repository for an entity type using Dapper.
    /// </summary>
    /// <typeparam name="TEntity">The entity type.</typeparam>
    /// <typeparam name="TId">The entity identifier type.</typeparam>
    /// <param name="services">The service collection.</param>
