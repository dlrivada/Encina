...
using Encina.Dapper.PostgreSQL.Sharding.ReferenceTables;
...
namespace Encina.Dapper.PostgreSQL.Sharding;

/// <summary>
/// Extension methods for configuring Encina Dapper PostgreSQL sharding services.
/// </summary>
public static class ShardingServiceCollectionExtensions
{
    /// <summary>
    /// Adds Encina sharded repository for a specific entity type using Dapper with PostgreSQL.
    /// </summary>
    ...
    /// <item><see cref="IFunctionalShardedRepository{TEntity, TId}"/> with PostgreSQL Dapper implementation</item>
    /// </list>
    /// </para>
    /// </remarks>
    /// <example>
    ...
    /// <summary>
    /// Adds Encina sharded read/write connection factory using Dapper with PostgreSQL.
    /// </summary>
    /// <param name="services">The service collection.</param>
    ...
    /// <summary>
    /// Registers the Dapper PostgreSQL reference table store factory for shard-based replication.
    /// </summary>
    /// <param name="services">The service collection.</param>
    /// <returns>The service collection for chaining.</returns>
