...
/// <summary>
/// Soft-delete-aware SQL builder for PostgreSQL that automatically prepends soft delete filters to queries.
/// </summary>
...
/// // whereClause: "WHERE \"IsDeleted\" = false AND (\"Status\" = @p0)"
/// </code>
/// </example>
