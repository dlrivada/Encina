...
namespace Encina.Dapper.PostgreSQL.Extensions;
...
/// Dapper for data access. They wrap the <see cref="AuditFieldPopulator"/> static methods
/// to provide a more natural syntax.
/// </para>
/// <para>
/// <b>When to Use</b>: Use these methods before executing INSERT or UPDATE operations
/// with Dapper, as there is no automatic interception like in EF Core.
/// </para>
/// </remarks>
/// <example>
/// <code>
