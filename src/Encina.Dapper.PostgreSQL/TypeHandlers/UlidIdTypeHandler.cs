...
/// <summary>
/// Dapper type handler for <see cref="UlidId"/> values in PostgreSQL.
/// PostgreSQL stores ULIDs as UUID (Guid), so this handler converts between <see cref="UlidId"/> and <see cref="Guid"/>.
/// </summary>
