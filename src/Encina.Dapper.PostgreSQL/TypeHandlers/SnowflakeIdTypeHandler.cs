...
/// <summary>
/// Dapper type handler for <see cref="SnowflakeId"/> values in PostgreSQL.
/// PostgreSQL stores Snowflake IDs as BIGINT, so this handler converts between <see cref="SnowflakeId"/> and <see cref="long"/>.
/// </summary>
