...
namespace Encina.Dapper.PostgreSQL.TypeHandlers;

/// <summary>
/// Dapper type handler for <see cref="ShardPrefixedId"/> values in PostgreSQL.
/// PostgreSQL stores shard-prefixed IDs as TEXT, so this handler converts between <see cref="ShardPrefixedId"/> and <see cref="string"/>.
/// </summary>
