...
/// <summary>
/// Dapper type handler for <see cref="UuidV7Id"/> values in PostgreSQL.
/// PostgreSQL stores UUIDv7 values as UUID (Guid), so this handler converts between <see cref="UuidV7Id"/> and <see cref="Guid"/>.
/// </summary>
