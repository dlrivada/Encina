...
namespace Encina.Dapper.PostgreSQL.Repository;

/// <summary>
/// Translates <see cref="Specification{T}"/> expressions to SQL clauses with Dapper parameters for PostgreSQL.
/// </summary>
...
/// <item><description>Native boolean support (TRUE/FALSE literals)</description></item>
    ...
    where TEntity : class
{
    ...
    public string BuildPaginationClause(IQuerySpecification<TEntity> specification)
    {
        ...
        // PostgreSQL allows OFFSET without LIMIT using LIMIT ALL
