...
/// <item><description>Native UUID (GUID) support - no type handler needed</description></item>
/// <item><description>Native boolean support - no conversion needed</description></item>
/// <item><description>Uses SELECT EXISTS for boolean queries</description></item>
/// </list>
/// </para>
/// <para>
    ...
    where TId : notnull
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var exists = await _connection.ExecuteScalarAsync<bool>(sql, parameters);
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            // PostgreSQL has native boolean support - SELECT EXISTS returns a proper boolean
            var exists = await _connection.ExecuteScalarAsync<bool>(_existsSql);
            return Right<EncinaError, bool>(exists);
        }
        catch (Exception ex)
        {
