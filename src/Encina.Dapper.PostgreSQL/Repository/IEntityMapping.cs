    ...
    where TId : notnull
{
    ...
    /// </summary>
    /// <remarks>
    /// The table name should be a valid PostgreSQL identifier. It can include
    /// schema prefixes like "public.orders" or quoted names like "Orders".
    ...
    /// PostgreSQL typically uses snake_case for column names.
    /// </remarks>
