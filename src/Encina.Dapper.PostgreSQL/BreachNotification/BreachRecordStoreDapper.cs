...
namespace Encina.Dapper.PostgreSQL.BreachNotification;

/// <summary>
/// Dapper implementation of <see cref="IBreachRecordStore"/> for PostgreSQL.
...
public sealed class BreachRecordStoreDapper : IBreachRecordStore
{
    ...
    /// <summary>
    /// Loads all phased reports for a given breach from the phased reports table.
    /// </summary>
    ...
    /// <summary>
    /// Creates the parameter object for breach record INSERT/UPDATE operations.
    /// DateTimeOffset values are passed directly (native PostgreSQL TIMESTAMPTZ support).
    /// </summary>
    /// <param name="entity">The breach record entity.</param>
    /// <returns>An anonymous object containing all parameters.</returns>
    ...
    /// <summary>
    /// Maps a dynamic row from Dapper to a <see cref="BreachRecordEntity"/>.
    /// DateTimeOffset values are cast directly (native PostgreSQL TIMESTAMPTZ support).
    /// Integer values are cast directly from dynamic rows.
    /// </summary>
    ...
    /// <summary>
    /// Maps a dynamic row from Dapper to a <see cref="PhasedReportEntity"/>.
    /// DateTimeOffset values are cast directly (native PostgreSQL TIMESTAMPTZ support).
    /// </summary>
    /// <param name="row">The dynamic row returned by Dapper.</param>
