...
/// <summary>
/// SQLite Dapper implementation of <see cref="IShardedReadWriteConnectionFactory"/> that
/// combines shard routing with read/write separation.
/// </summary>
/// <remarks>
/// <para>
/// Creates <see cref="SqliteConnection"/> instances (returned as <see cref="IDbConnection"/>)
