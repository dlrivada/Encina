...
public static class EntityMappingErrorCodes
{
    ...
    /// </summary>
    public const string MissingTableName = "dapper.sqlite.mapping.missing_table_name";

    /// <summary>
    /// The primary key was not configured in the entity mapping.
    /// </summary>
    public const string MissingPrimaryKey = "dapper.sqlite.mapping.missing_primary_key";

    /// <summary>
    /// No column mappings were configured in the entity mapping.
    /// </summary>
    public const string MissingColumnMappings = "dapper.sqlite.mapping.missing_column_mappings";

    /// <summary>
    /// The tenant column was not configured in the tenant entity mapping.
    /// </summary>
    public const string MissingTenantColumn = "dapper.sqlite.mapping.missing_tenant_column";
}
