...
/// <summary>
/// Fluent builder for configuring soft-delete-aware entity-to-table mappings for SQLite.
/// </summary>
...
/// <summary>
/// Internal implementation of <see cref="ISoftDeleteEntityMapping{TEntity, TId}"/> for SQLite.
/// </summary>
