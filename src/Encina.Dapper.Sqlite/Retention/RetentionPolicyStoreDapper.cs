...
/// <summary>
/// Dapper implementation of <see cref="IRetentionPolicyStore"/> for SQLite.
...
/// <item><description>Boolean values are stored as integers (0/1).</description></item>
/// <item><description>TimeSpan is stored as ticks (long) for portability.</description></item>
/// </list>
/// </para>
/// </remarks>
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            await _connection.ExecuteAsync(sql, new
            {
                ...
                LastModifiedAtUtc = entity.LastModifiedAtUtc?.ToString("O")
            });
    ...
    private static RetentionPolicyEntity MapToEntity(dynamic row)
    {
        return new RetentionPolicyEntity
        {
            ...
            LastModifiedAtUtc = row.LastModifiedAtUtc is null or DBNull
                ? null
                : DateTimeOffset.Parse((string)row.LastModifiedAtUtc, null, DateTimeStyles.RoundtripKind)
        };
    }
}
