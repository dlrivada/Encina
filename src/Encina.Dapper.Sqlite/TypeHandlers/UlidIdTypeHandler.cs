...
/// <summary>
/// Dapper type handler for <see cref="UlidId"/> values in SQLite.
/// SQLite stores ULIDs as TEXT (Crockford Base32), so this handler converts between <see cref="UlidId"/> and <see cref="string"/>.
/// </summary>
