...
/// <summary>
/// Extension methods for configuring Encina Dapper with multi-tenancy support for SQLite.
/// </summary>
public static class TenancyServiceCollectionExtensions
{
    /// <summary>
    /// Adds Encina messaging patterns with Dapper persistence and multi-tenancy support for SQLite.
    /// </summary>
    ...
    /// <summary>
    /// Registers a tenant-aware functional repository for an entity type using Dapper for SQLite.
    /// </summary>
    ...
    /// <summary>
    /// Registers a read-only tenant-aware repository for an entity type using Dapper for SQLite.
    /// </summary>
    /// <typeparam name="TEntity">The entity type.</typeparam>
    /// <typeparam name="TId">The entity identifier type.</typeparam>
    /// <param name="services">The service collection.</param>
