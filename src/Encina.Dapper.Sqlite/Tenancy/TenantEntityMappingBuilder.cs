...
/// <summary>
/// Fluent builder for configuring tenant-aware entity-to-table mappings.
/// </summary>
    ...
    where TId : notnull
{
    ...
    /// </summary>
    /// <param name="tableName">The table name (SQLite does not support schemas).</param>
...
/// <summary>
/// Internal implementation of <see cref="ITenantEntityMapping{TEntity, TId}"/>.
/// </summary>
