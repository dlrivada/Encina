...
/// <summary>
/// SQLite implementation of <see cref="ITenantConnectionFactory"/> for multi-tenant
/// database connection management.
/// </summary>
/// <remarks>
/// <para>
/// This factory creates <see cref="SqliteConnection"/> instances configured for the current
...
/// </list>
/// <para>
/// <b>Note:</b> SQLite does not support schema-per-tenant isolation. For schema isolation,
/// consider using separate database files per tenant.
/// </para>
/// </remarks>
/// <example>
/// <code>
...
public sealed class TenantConnectionFactory : ITenantConnectionFactory
{
    ...
    public async ValueTask<Either<EncinaError, IDbConnection>> CreateConnectionAsync(CancellationToken cancellationToken = default)
    {
        ...
        return connectionStringResult.Map(cs => (IDbConnection)new SqliteConnection(cs));
    }
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return GetConnectionStringForTenant(tenant)
            .Map(cs => (IDbConnection)new SqliteConnection(cs));
    }
