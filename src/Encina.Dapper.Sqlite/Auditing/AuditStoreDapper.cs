...
/// <summary>
/// Dapper implementation of <see cref="IAuditStore"/> for SQLite.
/// </summary>
/// <remarks>
/// <para>
...
/// <item><description>TEXT for datetime storage (ISO 8601 format)</description></item>
/// <item><description>LIMIT/OFFSET for pagination</description></item>
/// </list>
/// </para>
/// <para>
/// <b>Important</b>: DateTime comparisons use parameterized values from C# DateTime.UtcNow,
...
public sealed class AuditStoreDapper : IAuditStore
{
    ...
    public AuditStoreDapper(IDbConnection connection, string tableName = "SecurityAuditEntries")
    {
        ...
        // SQLite uses changes() to get affected rows count
        _purgeSql = $@"
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            var parameters = new
            {
                ...
                entry.ErrorMessage,
                entry.TimestampUtc,
                StartedAtUtc = entry.StartedAtUtc.ToString("o"),
                CompletedAtUtc = entry.CompletedAtUtc.ToString("o"),
                entry.IpAddress,
                entry.UserAgent,
    ...
    private static AuditEntry MapToEntry(AuditEntryRow row) => new()
    {
        ...
        StartedAtUtc = ParseDateTimeOffset(row.StartedAtUtc),
        CompletedAtUtc = ParseDateTimeOffset(row.CompletedAtUtc),
