...
/// <summary>
/// Extension methods for <see cref="IApplicationBuilder"/> to configure SimpleMediator middleware.
/// </summary>
public static class ApplicationBuilderExtensions
{
    /// <summary>
    /// Adds SimpleMediator context enrichment middleware to the application pipeline.
    /// </summary>
    ...
    /// but before any middleware that uses SimpleMediator.
    /// </para>
    /// </remarks>
    /// <example>
    /// <code>
    ...
    /// app.UseSimpleMediatorContext(); // After auth, before endpoints
    ///
    /// app.MapControllers();
    /// app.Run();
    /// </code>
    /// </example>
    public static IApplicationBuilder UseSimpleMediatorContext(this IApplicationBuilder app)
    {
        return app.UseMiddleware<SimpleMediatorContextMiddleware>();
    }
}
