...
[![NuGet](https://img.shields.io/nuget/v/SimpleMediator.AspNetCore.svg)](https://www.nuget.org/packages/SimpleMediator.AspNetCore/)
[![License: MIT](https://img.shields.io/badge/License-MIT-blue.svg)](../../LICENSE)

ASP.NET Core integration for SimpleMediator with Railway Oriented Programming support. This package provides seamless integration between SimpleMediator and ASP.NET Core, enabling request context enrichment, authorization, and standardized error handling.
...
```bash
dotnet add package SimpleMediator.AspNetCore
```
...
app.UseAuthentication(); // Must come before UseSimpleMediatorContext
app.UseSimpleMediatorContext(); // Enriches IRequestContext from HttpContext
...
The `SimpleMediatorContextMiddleware` automatically enriches `IRequestContext` from the incoming HTTP request:
...
### SimpleMediatorAspNetCoreOptions
...
SimpleMediator.AspNetCore works seamlessly with other SimpleMediator satellite packages:
...
- **SimpleMediator.EntityFrameworkCore** - Transaction management, outbox pattern, multi-tenancy query filters
- **SimpleMediator.Dapper** - Lightweight data access with minimal overhead
- **SimpleMediator.Data** - Pure ADO.NET for maximum performance

## Additional Resources

- [SimpleMediator Core Documentation](../../README.md)
