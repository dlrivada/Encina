...
| License | Reciprocal Public License 1.5, with a commercial license and a required license key for production use ([Lucky Penny Software licence terms](https://github.com/LuckyPennySoftware/MediatR/blob/master/LICENSE.md)) | MIT (repository `LICENSE`) |
