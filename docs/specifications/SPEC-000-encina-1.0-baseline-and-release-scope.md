...
- **REQ-029** The pre-1.0 scope decided in SPEC-002 is part of the 1.0 contract. Every SPEC-002 requirement placed before 1.0 is implemented and verified before `1.0.0-rc.1`: the items of SPEC-002 §11.2 table 1 (SPEC-002 DEC-011 (a) + (d) + (e), SPEC-002 DEC-009 (b), SPEC-002 DEC-005 (a)) and table 2 (the integration and platform capabilities of SPEC-002 §5.11, SPEC-002 REQ-039 – SPEC-002 REQ-058), together with the SPEC-002 requirements that refine or extend requirements of this document (SPEC-002 REQ-022 refines REQ-024, SPEC-002 REQ-024 refines REQ-026, SPEC-002 REQ-026 – SPEC-002 REQ-030 extend REQ-018 – REQ-022, and the SPEC-002 defect requirements fall under REQ-011 as well). Two parts stay outside the contract, as SPEC-002 states: the rules part of SPEC-002 REQ-011 (post-1.0; its persisted shape is in 1.0), and SPEC-002 REQ-059, which is in 1.0 only if SPEC-002 §12 question 1 is answered yes. An item SPEC-002 promotes into the P0 backlog cites this requirement and the SPEC-002 requirement it implements (INV-004).
...
| AC-029 | REQ-029 | On the release-candidate commit, SPEC-002 AC-001 – SPEC-002 AC-039 and SPEC-002 AC-042 – SPEC-002 AC-044 hold, and SPEC-002 AC-041 holds if SPEC-002 §12 question 1 was answered yes; the PracticeManagement reference scenario is green in CI Full with tenancy on (SPEC-002 AC-038); the SPEC-002 EPIC is closed. |
