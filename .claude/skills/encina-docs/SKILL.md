...
5. **Provider matrix is complete or explicit.** A page about a provider-dependent feature either covers all providers of that category (`CLAUDE.md`, Multi-Provider Implementation Rule) or states which ones it covers and links the issue for the rest.
